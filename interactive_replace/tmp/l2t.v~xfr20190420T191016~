...
// 
// OpenSPARC T2 Processor File: l5t.v
...
`include "libs/clk/rtl/clkgen_l5t_cmp.v"
`include "libs/clk/n2_clk_clstr_hdr_cust_l/n2_clk_clstr_hdr_cust/rtl/n2_clk_clstr_hdr_cust.v"
`include "libs/cl/cl_u1/cl_u1.v"
`include "libs/cl/cl_sc1/cl_sc1.v"
...
module l5t (
  ...
  l2b_l5t_ev_uerr_r5, 
  l2b_l5t_ev_cerr_r5, 
  l5t_l2b_rdma_wren_s2, 
  l5t_l2b_rdma_wrwl_s2, 
  l5t_l2b_rdma_rdwl_r0, 
  l5t_l2b_rdma_rden_r0, 
  l5t_l2b_ctag_en_c7, 
  l5t_l2b_ctag_c7, 
  l5t_l2b_word_c7, 
  l5t_l2b_req_en_c7, 
  l5t_l2b_word_vld_c7, 
  l5t_rst_fatal_error, 
  l2b_l5t_rdma_uerr_c10, 
  l2b_l5t_rdma_cerr_c10, 
  l2b_l5t_rdma_notdata_c10, 
  l5t_mcu_rd_req, 
  l5t_mcu_rd_dummy_req, 
  l5t_mcu_rd_req_id, 
  l5t_mcu_addr, 
  l5t_mcu_addr_5, 
  l5t_mcu_wr_req, 
  ...
  mcu_l5t_chunk_id_r0, 
  mcu_l5t_data_vld_r0, 
  mcu_l5t_rd_req_id_r0, 
  mcu_l5t_secc_err_r2, 
  mcu_l5t_mecc_err_r2, 
  mcu_l5t_scb_mecc_err, 
  mcu_l5t_scb_secc_err, 
  scan_in, 
  l5t_siu_delay, 
  sii_l5t_req_vld, 
  sii_l5t_req, 
  ...
  scan_out, 
  cluster_arst_l, 
  l5t_dbg_sii_iq_dequeue, 
  l5t_dbg_sii_wib_dequeue, 
  l5t_dbg_xbar_vcid, 
  l5t_dbg_err_event, 
  l5t_dbg_pa_match, 
  efu_l5t_fuse_clr, 
  efu_l5t_fuse_xfer_en, 
  efu_l5t_fuse_data, 
  l5t_efu_fuse_data, 
  l5t_efu_fuse_xfer_en, 
  tcu_mbist_bisi_en, 
  tcu_l5t_mbist_start, 
  tcu_l5t_mbist_scan_in, 
  tcu_mbist_user_mode, 
  l5t_tcu_mbist_done, 
  l5t_tcu_mbist_fail, 
  l5t_tcu_mbist_scan_out, 
  l5t_rep_in0, 
  l5t_rep_in1, 
  l5t_rep_in2, 
  l5t_rep_in3, 
  ...
  l5t_lstg_out, 
  l5t_rstg_out, 
  tcu_l5t_shscan_scan_in, 
  tcu_l5t_shscan_aclk, 
  tcu_l5t_shscan_bclk, 
  tcu_l5t_shscan_scan_en, 
  tcu_l5t_shscan_pce_ov, 
  tcu_l5t_shscan_clk_stop, 
  l5t_tcu_shscan_scan_out, 
  tcu_l5t_coresel, 
  tcu_l5t_tag_or_data_sel, 
  l5t_tcu_dmo_out_prev, 
  l5t_tcu_dmo_out) ;
wire array_wr_inhibit;
wire l5t_clk_header_scanin;
wire l5t_clk_header_scanout;
wire aclk;
wire bclk;
wire ce_ovrd;
wire wmr_protect;
...
wire tag_scanin;
wire tag_scanout;
wire [6:0] l5t_tag_rvalue;
wire [3:0] l5t_tag_rid;
wire l5t_tag_wr_en;
wire l5t_tag_fuse_clr;
wire mbist_run;
...
wire arbadr_tagd_ncu_l5t_pm_n_dist;
wire tagd_scanin;
wire tagd_scanout;
wire [38:0] l5t_tcu_dmo_out_unbuff;
wire [38:0] l5t_tcu_dmo_out_prev_buff;
wire dmologic_scanin;
wire dmologic_scanout;
wire tcu_l5t_shscan_clk_stop_d2;
wire mbist_start_mb0;
wire mbist_start_mb2;
wire l5t_tcu_mbist0_done;
wire l5t_tcu_mbist2_done;
wire l5t_tcu_mbist0_fail;
wire l5t_tcu_mbist2_fail;
wire [7:0] mbist_write_data_decck;
wire tcu_l5t_mbist_scan_in1;
...
wire tagctl_scanout;
wire l5t_mb2_mbdata_wr_en;
wire l5t_mb2_mbdata_rd_en;
wire l5t_mb2_mbtag_rd_en;
wire l5t_mb2_mbtag_wr_en;
wire [4:0] l5t_mb2_addr;
...
wire mbtag_scanin;
wire mbtag_scanout;
wire l5t_mb2_fbtag_wr_en;
wire l5t_mb2_fbtag_rd_en;
...
wire l5t_mb2_mbtag_lookup_en;
wire l5t_mb2_fbtag_lookup_en;
wire l5t_mb2_wbtag_lookup_en;
wire l5t_mb2_rdmatag_lookup_en;
wire arbdec_arbdp_inst_rsvd_c1_1;
wire arb_scanin;
wire arb_scanout;
wire [5:0] l5t_dbg_xbar_vcid_transfer;
wire arbdec_scanin;
wire arbdec_scanout_1;
wire arbdec_scanout;
wire l5t_mb2_rdmatag_rd_en;
wire l5t_mb2_wbtag_wr_en;
wire l5t_mb2_wbtag_rd_en;
...
wire wbtag_scanout;
wire iqu_fail_reg;
wire ique_pcx_l5t_data_103_px2;
wire ique_scanin;
wire ique_scanout;
wire iqu_hold_rd_n;
wire l5t_mb2_iqarray_wr_en;
wire l5t_mb2_iqarray_rd_en;
wire iqu_scanin;
wire iqu_scanout;
wire [129:0] pcx_l5t_data_px2_fnl;
wire iqarray_scanin;
wire iqarray_scanout;
wire [3:0] dirrep_dc_lkup_row_dec_c4;
wire [5:0] l5t_mb0_addr;
wire oqu_scanin;
wire oqu_scanout;
wire oqarray_scanin;
wire oqarray_scanout;
wire [7:0] mb0_l5t_mbist_write_data;
wire l5t_mb0_run;
...
wire csreg_scanin;
wire csreg_scanout;
wire l5t_dbg_sii_iq_dequeue_unreg;
wire snp_scanin;
wire snp_scanout;
wire snpd_scanin;
wire snpd_scanout;
...
wire [1:0] l5t_mb0_icrow_row_en;
wire [15:0] l5t_mb0_lookup_wdata;
...
wire [7:0] l5t_mb0_mask;
wire [3:0] l5t_mb0_icrow_panel_en;
wire [3:0] l5t_mb0_icrow_lookup_en;
wire l5t_mb0_icrow_wr_en;
wire l5t_mb0_icrow_rd_en;
...
wire [3:0] l5t_mb0_dcrow_panel_en;
wire [3:0] l5t_mb0_dcrow_lookup_en;
wire l5t_mb0_dcrow_wr_en;
wire l5t_mb0_dcrow_rd_en;
...
wire l5t_mb2_rdmatag_wr_en;
wire mbdata_fail;
wire tcu_l5t_mbist_scan_in2;
wire l5t_mb0_oqarray_wr_en;
wire l5t_mb0_oqarray_rd_en;
wire l5tag_sram_hdr_scanin;
wire l5tag_sram_hdr_scanout;
wire rdmat_scanin;
...
output [7:0]     l5t_cpx_req_cq;   // l5t to processor request // 
output           l5t_cpx_atom_cq; // 
output [`CPX_WIDTH_LESS1:0]  l5t_cpx_data_ca;  // l5t to cpx data pkt // 
output           l5t_pcx_stall_pq; // l5t to pcx IQ_full stall // 
 
input		pcx_l5t_data_rdy_px1; // 
input [`PCX_WIDTH_LESS1:0]  pcx_l5t_data_px2;   // 
input		pcx_l5t_atm_px1; // 
input	[7:0]	cpx_l5t_grant_cx; // 

//////////////////////////////////////////////////////////////////////////////
// NCU interface : BS 03/25/04 for partial bank/core modes support
//////////////////////////////////////////////////////////////////////////////

input           ncu_l5t_pm;   // 0:all 8 banks available, 1:partial mode 
			      //and need to look at each *ba* signals)
input		ncu_l5t_ba01; // 0:bank0 and bank1 unavailable, 1:both banks available 
input           ncu_l5t_ba23; // 0:bank2 and bank3 unavailable, 1:both banks available
input           ncu_l5t_ba45; // 0:bank4 and bank5 unavailable, 1:both banks available
input           ncu_l5t_ba67; // 0:bank6 and bank7 unavailable, 1:both banks available
...
input [155:0]   l2d_l5t_decc_c6;    // From data of l2d_data.v // 

output	[15:0]	l5t_l2d_way_sel_c2; // 
output	      	l5t_l2d_rd_wr_c2; // 
output	[8:0]	l5t_l2d_set_c2; // 
output	[3:0]	l5t_l2d_col_offset_c2; // 
output	[15:0]	l5t_l2d_word_en_c2; // 
output          l5t_l2d_fbrd_c3;   // From arb of l5t_arb_ctl.sv // 
output          l5t_l2d_fb_hit_c3; // bypass data from Fb  // 
output [77:0]   l5t_l2d_stdecc_c2;// store data.  // 
...
//output [77:0]   l5t_l2b_stdecc_c3;// store data. staged version to l2b // 
output		l5t_l2b_fbrd_en_c3; // rd en for a fill operation or fb bypass // 
output	[2:0]	l5t_l2b_fbrd_wl_c3 ; // read entry // 
output	[15:0]	l5t_l2b_fbwr_wen_r2 ; // mcu Fill or store in OFF mode. // 
output	[2:0]	l5t_l2b_fbwr_wl_r2 ; // mcu Fill entry. // 
output		l5t_l2b_fbd_stdatasel_c3; // select store data in OFF mode // 
 
output	[3:0]	l5t_l2b_wbwr_wen_c6; // write en // 
output	[2:0]	l5t_l2b_wbwr_wl_c6; // from wbuf // 
output		l5t_l2b_wbrd_en_r0; // triggerred by a wr_ack from mcu // 
output	[2:0]	l5t_l2b_wbrd_wl_r0;  // 
 
output	[2:0]	l5t_l2b_ev_dword_r0; // 
output          l5t_l2b_evict_en_r0;// From wbuf of l5t_wbuf_ctl.sv // 
input		l2b_l5t_ev_uerr_r5; // 
input		l2b_l5t_ev_cerr_r5; // 
 
// START interface with l2b for handling rdma  reads and writes 

output	[15:0]	l5t_l2b_rdma_wren_s2; // may be all 1s // 
output	[1:0]	l5t_l2b_rdma_wrwl_s2; // 
output	[1:0]	l5t_l2b_rdma_rdwl_r0; // 
output		l5t_l2b_rdma_rden_r0; // 
 
output		l5t_l2b_ctag_en_c7 ; // 
output  [31:0]  l5t_l2b_ctag_c7 ;    //  

// RAS implementation changes 10/14/04
output	[3:0]	l5t_l2b_word_c7 ; // // 
output		l5t_l2b_req_en_c7 ;	// This signal is s one cycle pulse // 
output		l5t_l2b_word_vld_c7; // This signal is high for 16 signals. // 
output		l5t_rst_fatal_error; // Fatal error to rst block on LVU and LRU
 
input		l2b_l5t_rdma_uerr_c10; // 
input		l2b_l5t_rdma_cerr_c10; // 
input           l2b_l5t_rdma_notdata_c10; // 
...
output			l5t_mcu_rd_req; // 
output			l5t_mcu_rd_dummy_req; // 
output [2:0]  		l5t_mcu_rd_req_id; // 
output [39:7] 		l5t_mcu_addr; // 
output                  l5t_mcu_addr_5;// 
output        		l5t_mcu_wr_req; // 
 
input         		mcu_l5t_rd_ack; // 
input         		mcu_l5t_wr_ack; // 
input  [1:0]   		mcu_l5t_chunk_id_r0; // 
input         		mcu_l5t_data_vld_r0; // 
input  [2:0]   		mcu_l5t_rd_req_id_r0; // 
input			mcu_l5t_secc_err_r2 ; // 
input			mcu_l5t_mecc_err_r2 ; // 
input			mcu_l5t_scb_mecc_err; // 
input			mcu_l5t_scb_secc_err; // 
input                   scan_in; // 
...
input           	l5t_siu_delay;
input			sii_l5t_req_vld ;  // 
input	[31:0]		sii_l5t_req; // 
input   [ 6:0]          sii_l2b_ecc; // RAS implementation 10/14/04
output			l5t_sii_iq_dequeue; // 
output			l5t_sii_wib_dequeue; // 
...
output		l5t_dbg_sii_iq_dequeue;
output		l5t_dbg_sii_wib_dequeue;
output	[5:0] 	l5t_dbg_xbar_vcid;
output		l5t_dbg_err_event;
output		l5t_dbg_pa_match; 
 
////////////////////////////////////////////////////////////////////////////// 
// Efuse interface signals 
////////////////////////////////////////////////////////////////////////////// 
input		efu_l5t_fuse_clr;
input		efu_l5t_fuse_xfer_en;
input		efu_l5t_fuse_data;
output		l5t_efu_fuse_data;
output		l5t_efu_fuse_xfer_en;
///////////////////////////////////////////////////////////////////////////////// 
// MBIST related pins
//////////////////////////////////////////////////////////////////////////////
input           tcu_mbist_bisi_en;
input           tcu_l5t_mbist_start;
input           tcu_l5t_mbist_scan_in;
input           tcu_mbist_user_mode;

output     	l5t_tcu_mbist_done;
output     	l5t_tcu_mbist_fail;
output    	l5t_tcu_mbist_scan_out;

/////////////////////////////////////////////////////////////////////////////////
// Repeaters
/////////////////////////////////////////////////////////////////////////////////

input    [23:0]  l5t_rep_in0;
input    [23:0]  l5t_rep_in1;
input    [23:0]  l5t_rep_in2;
input    [23:0]  l5t_rep_in3;
input    [23:0]  l5t_rep_in4;
input    [23:0]  l5t_rep_in5;
input    [23:0]  l5t_rep_in6;
input    [23:0]  l5t_rep_in7;
input    [23:0]  l5t_rep_in8;
input    [23:0]  l5t_rep_in9;
input    [23:0]  l5t_rep_in10;
input    [23:0]  l5t_rep_in11;
input    [23:0]  l5t_rep_in12;
input    [23:0]  l5t_rep_in13;
input    [23:0]  l5t_rep_in14;
input    [23:0]  l5t_rep_in15;
input    [23:0]  l5t_rep_in16;
input    [23:0]  l5t_rep_in17;
input    [23:0]  l5t_rep_in18;
input    [23:0]  l5t_rep_in19;

output   [23:0]  l5t_rep_out0;
output   [23:0]  l5t_rep_out1;
output   [23:0]  l5t_rep_out2;
output   [23:0]  l5t_rep_out3;
output   [23:0]  l5t_rep_out4;
output   [23:0]  l5t_rep_out5;
output   [23:0]  l5t_rep_out6;
output   [23:0]  l5t_rep_out7;
output   [23:0]  l5t_rep_out8;
output   [23:0]  l5t_rep_out9;
output   [23:0]  l5t_rep_out10;
output   [23:0]  l5t_rep_out11;
output   [23:0]  l5t_rep_out12;
output   [23:0]  l5t_rep_out13;
output   [23:0]  l5t_rep_out14;
output   [23:0]  l5t_rep_out15;
output   [23:0]  l5t_rep_out16;
output   [23:0]  l5t_rep_out17;
output   [23:0]  l5t_rep_out18;
output   [23:0]  l5t_rep_out19;

input	[191:0]	l5t_lstg_in;
input	[191:0]	l5t_rstg_in;
output	[191:0]	l5t_lstg_out;
output	[191:0]	l5t_rstg_out;


/////////////////////////////////////////////////////////////////////////////////
// shadow scan 
/////////////////////////////////////////////////////////////////////////////////
input		tcu_l5t_shscan_scan_in;
input		tcu_l5t_shscan_aclk;	
input		tcu_l5t_shscan_bclk;   	
input		tcu_l5t_shscan_scan_en;
input		tcu_l5t_shscan_pce_ov;	
input		tcu_l5t_shscan_clk_stop;
output		l5t_tcu_shscan_scan_out;

/////////////////////////////////////////////////////////////////////////////////
// DMO interface changes
/////////////////////////////////////////////////////////////////////////////////
input		tcu_l5t_coresel;	// 1= select current bank dmo out
input		tcu_l5t_tag_or_data_sel;// 1= tag read data 0 = data read data
input	[38:0]	l5t_tcu_dmo_out_prev;	// dmo output from prev bank
output	[38:0]	l5t_tcu_dmo_out;	// dmo output from this bank
...
// BS 04/20/04 , taking out arb_bs_or_bis_inst_c2 to l5t_usaloc_dp.sv 
...
wire [39:0]            wb_read_data;           // To arbadr of l5t_arbadr_dp.sv 
 
wire [7:0]             fb_cam_match;           // To filbuf of l5t_filbuf_ctl.sv // BS and SR 8 deep change 3/3/04
wire [39:0]            fb_read_data;           // To arbadr of l5t_arbadr_dp.sv 
 
wire [159:0]           iq_array_rd_data_c1;    // To ique of l5t_ique_dp.sv 
wire [31:0]            mb_cam_match;           // To misbuf of l5t_misbuf_ctl.sv , BS & SR 11/04/03, MB grows to 32
wire [31:0]            mb_cam_match_idx;           // To misbuf of l5t_misbuf_ctl.sv, BS & SR 11/05/03 MB grows to 32
 
wire [41:0]            mb_read_data;           // To l5t_evctag_dp.sv
wire [39:0]            evctag_mb_read_data;    // from l5t_evctag_dp.sv to  fbtag and mbist module 

wire [159:0]  oq_array_data_out;      // To oque of l5t_oque_dp.sv 
 
wire [7:0]             wb_cam_match_c2;        // To wbuf of l5t_wbuf_ctl.sv // BS and SR 8 deep change 3/3/04
// wire [31:0]            wr_data;                // To icdir of l5t_dirblock.v, ... 
...
wire	mbist_l5tag_fail; 
wire	mbist_l2data_fail; 
 

wire [2:0]              lkup_row_addr_icd_c3;   //  
wire [2:0]              lkup_row_addr_dcd_c3;   //  
wire [17:9]          	tagd_lkup_addr_c4;     // From tagd of l5t_tagd_dp.sv, BS and SR 11/18/03 Reverse Directory change 
...
wire                    alloc_rst_cond_c3;      // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    alloc_set_cond_c3;      // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    tag_alt_tag_miss_unqual_c3;// From tag of l5t_tag_ctl.sv 
wire                    arbaddr_addr22_c2;      // From arbadr of l5t_arbadr_dp.sv 
wire [10:0]              arbaddr_idx_c3;         // From arbadr of l5t_arbadr_dp.sv 
wire                    arbadr_addr2_c8;     // From arbadr of l5t_arbadr_dp.sv 
wire                    arb_acc_ua_c2;       // From arb of l5t_arb_ctl.sv 
wire                    arb_acc_vd_c2;       // From arb of l5t_arb_ctl.sv 
wire                    arb_csr_rd_en_c3;    // From arb of l5t_arb_ctl.sv 
wire                    arb_csr_rd_en_c7;    // From arb of l5t_arb_ctl.sv 
wire                    arb_csr_st_c2;       // From arb of l5t_arb_ctl.sv 
wire                    arb_csr_wr_en_c3;    // From arb of l5t_arb_ctl.sv 
wire                    arb_csr_wr_en_c7;    // From arb of l5t_arb_ctl.sv 
wire                    arb_data_diag_st_c2; // From arb of l5t_arb_ctl.sv 
wire                    arb_dc_rd_en_c3;     // From arb of l5t_arb_ctl.sv 
wire                    arb_dc_wr_en_c3;     // From arb of l5t_arb_ctl.sv 
wire                    arb_decc_data_sel_c9;// From arb of l5t_arb_ctl.sv 
wire                    arb_diag_complete_c3;// From arb of l5t_arb_ctl.sv 
wire [4:0]              arb_dir_panel_dcd_c3;// From arb of l5t_arb_ctl.sv 
wire [4:0]              arb_dir_panel_icd_c3;// From arb of l5t_arb_ctl.sv 
wire                    arb_dir_vld_c3_l;    // From arb of l5t_arb_ctl.sv 
wire                    arb_dir_wr_en_c4;    // From arb of l5t_arb_ctl.sv 
wire                    arb_evict_c3;        // From arb of l5t_arb_ctl.sv 
wire                    arb_evict_c4;        // From arb of l5t_arb_ctl.sv 
wire                    arb_evict_c5;        // From arb of l5t_arb_ctl.sv 
wire                    arb_evict_tecc_vld_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_evict_vld_c2;    // From arb of l5t_arb_ctl.sv 
wire                    arb_filbuf_fbsel_c1;  // From arb of l5t_arb_ctl.sv 
wire                    arb_filbuf_hit_off_c1;// From arb of l5t_arb_ctl.sv 
//wire                    arb_filbuf_inst_vld_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_fill_vld_c2;     // From arb of l5t_arb_ctl.sv 
wire                    arb_ic_rd_en_c3;     // From arb of l5t_arb_ctl.sv 
wire                    arb_ic_wr_en_c3;     // From arb of l5t_arb_ctl.sv 
wire                    arb_imiss_hit_c10;   // From arb of l5t_arb_ctl.sv 
wire                    arb_imiss_hit_c4;    // From arb of l5t_arb_ctl.sv 
wire                    arb_imiss_vld_c2;    // From arb of l5t_arb_ctl.sv 
wire                    arb_inst_diag_c1;    // From arb of l5t_arb_ctl.sv 
wire                    arb_inst_l2data_vld_c6;// From arb of l5t_arb_ctl.sv 
wire                    arb_inst_l5tag_vld_c6;// From arb of l5t_arb_ctl.sv 
wire                    arb_inst_l2vuad_vld_c3;// From arb of l5t_arb_ctl.sv 
wire                    arb_inst_l2vuad_vld_c6;// From arb of l5t_arb_ctl.sv 
wire                    arb_inst_vld_c2;     // From arb of l5t_arb_ctl.sv 
wire                    arb_inval_inst_c2;   // From arb of l5t_arb_ctl.sv 
wire [7:0]              arb_inval_mask_dcd_c3;// From arb of l5t_arb_ctl.sv 
wire [7:0]              arb_inval_mask_icd_c3;// From arb of l5t_arb_ctl.sv 
wire                    arb_iqsel_px2;       // From arb of l5t_arb_ctl.sv 
wire                    arb_l5tag_vld_c4;    // From arb of l5t_arb_ctl.sv 
wire [3:0]              arb_lkup_bank_ena_dcd_c3;// From arb of l5t_arb_ctl.sv 
wire [3:0]              arb_lkup_bank_ena_icd_c3;// From arb of l5t_arb_ctl.sv 
wire                    arb_misbuf_cas1_hit_c8;// From arb of l5t_arb_ctl.sv 
wire                    arb_misbuf_ctrue_c9;  // From arb of l5t_arb_ctl.sv 
wire                    arb_misbuf_hit_off_c1;// From arb of l5t_arb_ctl.sv 
wire                    arb_misbuf_inst_vld_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_misbuf_mbsel_c1;  // From arb of l5t_arb_ctl.sv 
wire                    arb_normal_tagacc_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_pst_ctrue_en_c8; // From arb of l5t_arb_ctl.sv 
wire                    arb_rdwr_inst_vld_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_tag_rd_px2;      // From arb of l5t_arb_ctl.sv 
wire                    tagd_arb_tag_rd_px2_buf;  // From tagd of l5t_tagd_dp.sv 
wire [15:0]             arb_tag_way_px2;     // From arb of l5t_arb_ctl.sv 
wire [15:0]             tagd_arb_tag_way_px2_buf; // From tagd of l5t_tagd_dp.sv 
wire                    arb_tag_wr_px2;      // From arb of l5t_arb_ctl.sv 
wire                    tagd_arb_tag_wr_px2_buf;  // From tagd of l5t_tagd_dp.sv 
wire                    arb_tag_inst_vld_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_tag_pst_with_ctrue_c1;// From arb of l5t_arb_ctl.sv 
wire                    arb_tagd_perr_vld_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_tagd_tecc_c2;   // From arb of l5t_arb_ctl.sv 
wire                    arb_tecc_c2;         // From arb of l5t_arb_ctl.sv 
wire [3:0]              arb_tecc_way_c2;     // From arb of l5t_arb_ctl.sv 
wire                    arb_vuad_acc_px2;    // From arb of l5t_arb_ctl.sv 
wire                    arb_vuad_idx2_sel_px2_n;// From arb of l5t_arb_ctl.sv 
wire                    arb_waysel_gate_c2;  // From arb of l5t_arb_ctl.sv 
wire                    arb_waysel_inst_vld_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_wbuf_hit_off_c1;// From arb of l5t_arb_ctl.sv 
wire                    arb_wbuf_inst_vld_c2;// From arb of l5t_arb_ctl.sv 
wire [4:0]              arb_wr_dc_dir_entry_c3;// From arb of l5t_arb_ctl.sv 
wire [4:0]              arb_wr_ic_dir_entry_c3;// From arb of l5t_arb_ctl.sv 
wire [31:0]             arbdec_ctag_c6;         // From arbdec of l5t_arbdec_dp.sv// Phase 2 : SIU inteface and packet format change 2/7/04
wire [7:0]              arbadr_arbdp_addr11to4_c3;     // From arbadr of l5t_arbadr_dp.sv 
wire                    arbadr_arbdp_addr22_c7;        // From arbadr of l5t_arbadr_dp.sv 
wire [1:0]              arbadr_arbdp_addr3to2_c1;      // From arbadr of l5t_arbadr_dp.sv 
wire [1:0]              arbadr_arbdp_addr5to4_c1;      // From arbadr of l5t_arbadr_dp.sv 
wire [1:0]              arbadr_arbdp_addr5to4_c3;      // From arbadr of l5t_arbadr_dp.sv 
wire                    arbadr_arbdp_addr_c1c2comp_c1; // From arbadr of l5t_arbadr_dp.sv 
wire                    arbadr_arbdp_addr_c1c3comp_c1; // From arbadr of l5t_arbadr_dp.sv 
wire                    arbadr_arbdp_addr_start_c2;    // From arbadr of l5t_arbadr_dp.sv 
wire [2:0]              arbadr_arbdp_byte_addr_c6;     // From arbadr of l5t_arbadr_dp.sv // Phase 2 of SIU changes
wire [2:0]              arbdec_arbdp_cpuid_c2;         // From arbdec of l5t_arbdec_dp.sv
wire [2:0]              arbdec_arbdp_cpuid_c5;         // From arbdec of l5t_arbdec_dp.sv 
wire [39:4]             arbadr_arbdp_csr_addr_c9;      // From arbadr of l5t_arbadr_dp.sv 
wire [3:0]              arbadr_arbdp_diag_wr_way_c2;   // From arbadr of l5t_arbadr_dp.sv 
wire                    arbdec_arbdp_evict_c1;         // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_bufid1_c1;   // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_bufidhi_c1;  // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_bufidlo_c2;  // From arbdec of l5t_arbdec_dp.sv 
wire [2:0]              arbdec_arbdp_inst_cpuid_c7;    // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_ctrue_c1;    // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_dep_c2;      // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_fb_c1;       // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_fb_c2;       // From arbdec of l5t_arbdec_dp.sv 
wire [1:0]              arbdec_arbdp_inst_l1way_c7;    // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_mb_c1;       // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_mb_c2;       // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_mb_c3;       // From arbdec of l5t_arbdec_dp.sv 
wire [4:0]              arbdec_arbdp_inst_mb_entry_c1; // From arbdec of l5t_arbdec_dp.sv, BS & SR 11/04/03, MB grows to 32 
wire                    arbdec_arbdp_inst_nc_c1;       // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_nc_c3;       // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_inst_nc_c7;       // From arbdec of l5t_arbdec_dp.sv 
wire [`L2_RQTYP_HI:`L2_RQTYP_LO]arbdec_arbdp_inst_rqtyp_c1;// From arbdec of l5t_arbdec_dp.sv 
wire [`L2_RQTYP_HI:`L2_RQTYP_LO]arbdec_arbdp_inst_rqtyp_c2;// From arbdec of l5t_arbdec_dp.sv 
wire [`L2_RQTYP_HI:`L2_RQTYP_LO]arbdec_arbdp_inst_rqtyp_c6;// From arbdec of l5t_arbdec_dp.sv 
//wire                    arbdec_arbdp_inst_rsvd_c1;     // From arbdec of l5t_arbdec_dp.sv 
wire [`L2_SZ_HI:`L2_SZ_LO]arbdec_arbdp_inst_size_c1;   // From arbdec of l5t_arbdec_dp.sv 
wire [7:0]              arbdec_arbdp_inst_size_c7;     // From arbdec of l5t_arbdec_dp.sv, BS and SR 11/12/03 N2 Xbar Packet format change 
wire                    arbdec_arbdp_inst_tecc_c3;     // From arbdec of l5t_arbdec_dp.sv 
wire [2:0]              arbdec_arbdp_inst_tid_c7;      // From arbdec of l5t_arbdec_dp.sv, BS and SR 11/12/03 N2 Xbar Packet format change 
wire [3:0]              arbdec_arbdp_inst_way_c1;      // From arbdec of l5t_arbdec_dp.sv 
wire [3:0]              arbdec_arbdp_inst_way_c2;      // From arbdec of l5t_arbdec_dp.sv 
wire [3:0]              arbdec_arbdp_inst_way_c3;      // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_int_bcast_c5;     // From arbdec of l5t_arbdec_dp.sv 
wire [39:32]            arbadr_arbdp_ioaddr_c1;        // From arbadr of l5t_arbadr_dp.sv 
wire [1:0]              arbdec_arbdp_l1way_c3;         // From arbdec of l5t_arbdec_dp.sv 
wire [5:4]              arbadr_arbdp_line_addr_c6;     // From arbadr of l5t_arbadr_dp.sv 
wire                    arb_arbdp_misbuf_pst_no_ctrue_c2;// From arb of l5t_arb_ctl.sv 
wire [1:0]              arbadr_arbdp_new_addr5to4_px2; // From arbadr of l5t_arbadr_dp.sv 
wire [17:0]             arbdat_arbdp_oque_int_ret_c7;  // From arbdat of l5t_arbdat_dp.sv 
wire [11:6]             arbadr_arbdp_oque_l1_index_c7; // From arbadr of l5t_arbadr_dp.sv 
wire                    arbdec_arbdp_poison_c1;        // From arbdec of l5t_arbdec_dp.sv 
wire                    arb_arbdp_pst_with_ctrue_c2;// From arb of l5t_arb_ctl.sv 
wire [1:0]              arbdec_arbdp_rdma_entry_c3;    // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_rdma_inst_c1;     // From arbdec of l5t_arbdec_dp.sv 
wire                    arbdec_arbdp_rdma_inst_c2;     // From arbdec of l5t_arbdec_dp.sv 
wire [5:2]              arbadr_arbdp_rdmat_addr_c6; // From arbadr of l5t_arbadr_dp.sv 
wire [8:0]              arbadr_arbdp_tag_idx_px2;      // From arbadr of l5t_arbadr_dp.sv 
wire                    arb_arbdp_tag_pst_no_ctrue_c2;// From arb of l5t_arb_ctl.sv 
wire [27:6]             arbadr_arbdp_tagdata_px2;      // From arbadr of l5t_arbadr_dp.sv 
wire                    arbdec_arbdp_tecc_c1;          // From arbdec of l5t_arbdec_dp.sv 
wire                    arb_arbdp_tecc_inst_mb_c8;  // From arb of l5t_arb_ctl.sv 
wire [8:0]              arbadr_arbdp_vuad_idx1_px2;    // From arbadr of l5t_arbadr_dp.sv 
wire [8:0]              arbadr_arbdp_vuad_idx2_px2;    // From arbadr of l5t_arbadr_dp.sv 
wire                    arb_arbdp_vuadctl_pst_no_ctrue_c2;// From arb of l5t_arb_ctl.sv 
wire [1:0]              arbadr_arbdp_waddr_c6;         // From arbadr of l5t_arbadr_dp.sv 
wire [4:0]              arbadr_arbdp_word_addr_c6;     // From arbadr of l5t_arbadr_dp.sv 
wire                    oqu_atm_inst_ack_c7;    // From oqu of l5t_oqu_ctl.sv 
wire                    arb_bist_or_diag_acc_c1;// From arb of l5t_arb_ctl.sv 
wire [38:0]             vuadpm_bistordiag_ua_data; // From vuadpm of l5t_vuadpm_dp.sv 
wire [38:0]             vuadpm_bistordiag_vd_data; // From vuadpm of l5t_vuadpm_dp.sv 
wire                    vuaddp_bistordiag_wr_ua_c4;// From vuaddp of l5t_vuaddp_ctl.sv 
wire                    vuaddp_bistordiag_wr_vd_c4; // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    arbadr_c1_addr_eq_wb_c4;    // From arbadr of l5t_arbadr_dp.sv 
wire                    tag_cerr_ack_tmp_c4;        // From tag of l5t_tag_ctl.sv 
wire                    csreg_csr_addr_wr_en;         // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_csr_async_wr_en;        // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_csr_bist_wr_en_c8;      // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_csr_wr_en_c8;           // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_csr_erren_wr_en_c8;     // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_csr_errinj_wr_en_c8;    // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_csr_errstate_wr_en_c8;  // From csreg of l5t_csreg_ctl.sv 
wire                    csr_filbuf_l2off;        // From csr of l5t_csr_ctl.sv 
wire                    csr_filbuf_scrub_ready;  // From csr of l5t_csr_ctl.sv 
wire [63:0]             arbdat_csr_inst_wr_data_c8; // From arbdat of l5t_arbdat_dp.sv 
wire                    csr_misbuf_l2off;        // From csr of l5t_csr_ctl.sv 
wire [63:0]             csr_rd_data_c8;         // From csr of l5t_csr_ctl.sv 
wire [3:0]              csreg_csr_rd_mux1_sel_c7;     // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_csr_rd_mux2_sel_c7;     // From csreg of l5t_csreg_ctl.sv 
wire [1:0]              csreg_csr_rd_mux3_sel_c7;     // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_csr_synd_wr_en;         // From csreg of l5t_csreg_ctl.sv 
wire                    csr_tag_l2off;       // From csr of l5t_csr_ctl.sv 
wire                    csreg_csr_tid_wr_en;          // From csreg of l5t_csreg_ctl.sv 
wire                    csr_vuad_l2off;         // From csr of l5t_csr_ctl.sv 
wire                    csr_wbuf_l2off;        // From csr of l5t_csr_ctl.sv 
wire                    csr_wr_dirpinj_en;      // From csr of l5t_csr_ctl.sv 
wire                    tag_data_ecc_active_c3; // From tag of l5t_tag_ctl.sv 
wire [8:0]              arbadr_data_ecc_idx;    // From arbadr of l5t_arbadr_dp.sv 
wire                    arb_data_ecc_idx_en;    // From arb of l5t_arb_ctl.sv 
wire                    arb_data_ecc_idx_reset; // From arb of l5t_arb_ctl.sv 
...
wire [38:0]             data_out_col_r0;        // From vuadcl_0 of l5t_vuadcl_dp.sv 
wire [38:0]             data_out_col_r10;       // From vuadcl_10 of l5t_vuadcl_dp.sv 
wire [38:0]             data_out_col_r2;        // From vuadcl_2 of l5t_vuadcl_dp.sv 
wire [38:0]             data_out_col_r8;        // From vuadcl_8 of l5t_vuadcl_dp.sv 
wire                    dirrep_dc_dir_clear_c4;  // From dirrep of l5t_dirrep_ctl.sv 
wire [7:0]              dc_inv_mask_0145;       // From dc_ctl_0145 of l5t_dir_ctl.sv 
wire [7:0]              dc_inv_mask_2367;       // From dc_ctl_2367 of l5t_dir_ctl.sv 
wire [7:0]              dc_inv_mask_89cd;       // From dc_ctl_89cd of l5t_dir_ctl.sv 
wire [7:0]              dc_inv_mask_abef;       // From dc_ctl_abef of l5t_dir_ctl.sv 
wire [3:0]              dirrep_dc_lkup_panel_dec_c4;   // From dirrep of l5t_dirrep_ctl.sv 
wire [3:0]              dc_lkup_row_dec_c4;     // From dirrep of l5t_dirrep_ctl.sv 
wire [15:0]             dc_lkup_wr_data_c4_row0;// From dc_buf_row0 of l5t_dirlbf_dp.sv, BS and SR 11/18/03 Reverse Directory change 
wire [15:0]             dc_lkup_wr_data_c4_row2;// From dc_buf_row1 of l5t_dirlbf_dp.sv , BS and SR 11/18/03 Reverse Directory change
wire [2:0]              dc_parity_in;           // From dc_out_col0 of l5t_dirout_dp.sv, ... 
wire [3:0]              dc_parity_out;          // From dc_out_col3 of l5t_dirout_dp.sv, ... 
...
wire                    dirrep_dc_rd_en_c4;     // From dirrep of l5t_dirrep_ctl.sv 
wire [3:0]              dirrep_dc_rdwr_panel_dec_c4; // From dirrep of l5t_dirrep_ctl.sv 
wire [3:0]              dirrep_dc_rdwr_row_en_c4;    // From dirrep of l5t_dirrep_ctl.sv 
wire [5:0]              dc_rw_addr_0145;        // From dc_ctl_0145 of l5t_dir_ctl.sv, BS and SR 11/18/03 Reverse Directory change 
wire [5:0]              dc_rw_addr_89cd;        // From dc_ctl_89cd of l5t_dir_ctl.sv, BS and SR 11/18/03 Reverse Directory change 
wire [4:0]              dc_rw_addr_abef;        // From dc_ctl_abef of l5t_dir_ctl.sv, BS and SR 11/18/03 Reverse Directory change 
wire                    dc_warm_rst_0145;       // From dc_ctl_0145 of l5t_dir_ctl.sv 
wire                    dc_warm_rst_89cd;       // From dc_ctl_89cd of l5t_dir_ctl.sv 
//wire                    dc_warm_rst_abef;       // From dc_ctl_abef of l5t_dir_ctl.sv 
wire                    dirrep_dc_wr_en_c4;     // From dirrep of l5t_dirrep_ctl.sv 
wire                    deccck_bscd_corr_err_c8;  // From deccck of l5t_deccck_ctl.sv 
wire                    deccck_bscd_uncorr_err_c8;// From deccck of l5t_deccck_ctl.sv 
wire                    deccck_scrd_corr_err_c8;  // From deccck of l5t_deccck_ctl.sv 
wire                    deccck_scrd_uncorr_err_c8;// From deccck of l5t_deccck_ctl.sv 
wire                    deccck_spcd_corr_err_c8;  // From deccck of l5t_deccck_ctl.sv 
wire                    deccck_spcd_uncorr_err_c8;// From deccck of l5t_deccck_ctl.sv 
wire                    deccck_spcfb_corr_err_c8; // From deccck of l5t_deccck_ctl.sv 
wire                    deccck_spcfb_uncorr_err_c8;// From deccck of l5t_deccck_ctl.sv 
wire                    tag_decc_tag_acc_en_px2;    // From tag of l5t_tag_ctl.sv 
wire                    deccck_uncorr_err_c8;     // From deccck of l5t_deccck_ctl.sv 
wire                    deccck_corr_err_c8;       // From deccck of l5t_deccck_ctl.sv
wire [63:0]             decc_arbdp_data_c8;   // From decc of l5t_decc_dp.sv 
wire                    arb_decdp_atm_inst_c6;      // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_bis_inst_c3;      // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_cas1_inst_c2;     // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_cas2_from_mb_c2;  // From arb of l5t_arb_ctl.sv 
//wire                    arb_decdp_cas2_from_mb_ctrue_c2;// From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_cas2_inst_c2;     // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_fwd_req_c2;       // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_imiss_inst_c2;    // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_inst_int_c2;      // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_inst_int_c1;      // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_ld64_inst_c1;     // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_ld64_inst_c2;     // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_ld_inst_c2;       // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_pf_inst_c5;       // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_pst_inst_c2;      // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_rmo_st_c3;        // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_st_inst_c2;       // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_st_inst_c3;       // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_st_with_ctrue_c2; // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_strld_inst_c6;    // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_strst_inst_c2;    // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_swap_inst_c2;     // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_tag_wr_c1;     // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_wr64_inst_c2;     // From arb of l5t_arb_ctl.sv 
wire                    arb_decdp_wr8_inst_c2;      // From arb of l5t_arb_ctl.sv 
wire                    arb_diag_or_tecc_write_px2; // From arb of l5t_arb_ctl.sv 
wire [38:0]             usaloc_diag_rd_ua_out;         // From usaloc of l5t_usaloc_dp.sv 
wire [38:0]             vlddir_diag_rd_vd_out;         // From vlddir of l5t_vlddir_dp.sv 
wire [10:0]             arb_dir_addr_c9;            // From arb of l5t_arb_ctl.sv 
wire [39:7]             arbadr_dir_cam_addr_c3;        // From arbadr of l5t_arbadr_dp.sv 
wire                    dirrep_dir_error_c8;           // From dirrep of l5t_dirrep_ctl.sv 
wire                    dirrep_dir_vld_c4_l;           // From dirrep of l5t_dirrep_ctl.sv 
wire [111:0]            dirvec_dirdp_inval_pckt_c7;    // From dirvec of l5t_dirvec_dp.sv 
wire [7:0]              dirvec_dirdp_req_vec_c6;       // From dirvec of l5t_dirvec_dp.sv 
wire [3:0]              dirvec_dirdp_way_info_c7;      // From dirvec of l5t_dirvec_dp.sv, BS and SR 11/18/03 Support for 8 way I$ 
wire                    vlddir_dirty_evict_c3;         // From vlddir of l5t_vlddir_dp.sv 
wire                    filbuf_mcu_scb_mecc_err_d1;   // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_mcu_scb_secc_err_d1;   // From filbuf of l5t_filbuf_ctl.sv 
wire [1:0]              filbuf_mcu_l5t_chunk_id_r1; // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_mcu_l5t_data_vld_r1; // From filbuf of l5t_filbuf_ctl.sv 
wire [7:0]              arb_dword_mask_c8;          // From arb of l5t_arb_ctl.sv 
wire                    deccck_dword_sel_c7;           // From deccck of l5t_deccck_ctl.sv 
wire [`ERR_LDAC:`ERR_LVC] csreg_err_state_in;          // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_err_state_in_mec;       // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_err_state_in_meu;       // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_err_state_in_rw;        // From csreg of l5t_csreg_ctl.sv 
wire                    csr_error_ceen;             // From csr of l5t_csr_ctl.sv 
wire                    csr_error_nceen;            // From csr of l5t_csr_ctl.sv 
wire                    csr_error_status_vec;       // From csr of l5t_csr_ctl.sv 
wire                    csr_error_status_veu;       // From csr of l5t_csr_ctl.sv 
wire                    rdmat_ev_cerr_r6;             // From rdmat of l5t_rdmat_ctl.sv 
wire                    rdmat_ev_uerr_r6;             // From rdmat of l5t_rdmat_ctl.sv 
wire [39:6]             evctag_evict_addr;             // From evctag of l5t_evctag_dp.sv 
wire [39:0]             evctag_addr_px2;      // From evctag of l5t_evctag_dp.sv 
wire                    filbuf_fb_count_eq_0;          // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_arb_l2rd_en;      // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_arb_vld_px1;   // From filbuf of l5t_filbuf_ctl.sv 
wire [2:0]              filbuf_arbdp_entry_px2;  // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_arbdp_tecc_px2;   // From filbuf of l5t_filbuf_ctl.sv 
wire [3:0]              filbuf_arbdp_way_px2;    // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_bsc_corr_err_c12; // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_corr_err_c8;      // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_dis_cerr_c3;      // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_dis_uerr_c3;      // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_fbd_rd_en_c2;     // From filbuf of l5t_filbuf_ctl.sv 
wire [2:0]              filbuf_fbd_rd_entry_c2;  // From filbuf of l5t_filbuf_ctl.sv 
wire [2:0]              filbuf_fbd_wr_entry_r1;  // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_ld64_fb_hit_c12;  // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_misbuf_entry_avail;// From filbuf of l5t_filbuf_ctl.sv 
wire [2:0]              filbuf_misbuf_fbid_d2;    // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_misbuf_match_c2;   // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_misbuf_nofill_d2;  // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_misbuf_stinst_match_c2;// From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_spc_corr_err_c6;  // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_spc_rd_vld_c6;    // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_spc_uncorr_err_c6;// From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_tag_hit_c2;    // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_uncorr_err_c8;    // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_vuad_bypassed_c3; // From filbuf of l5t_filbuf_ctl.sv 
wire [4:0]              filbuf_fbf_enc_dep_mbid_c4;    // From filbuf of l5t_filbuf_ctl.sv,BS & SR 11/04/03, MB grows to 32 
wire [4:0]              filbuf_fbf_enc_ld_mbid_r1;     // From filbuf of l5t_filbuf_ctl.sv, BS & SR 11/04/03, MB grows to 32 
wire                    filbuf_fbf_ready_miss_r1;      // From filbuf of l5t_filbuf_ctl.sv 
wire                    filbuf_fbf_st_or_dep_rdy_c4;   // From filbuf of l5t_filbuf_ctl.sv 
wire [15:0]             vuaddp_fill_way_c3;            // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    oqu_fwd_req_ret_c7;         // From oqu of l5t_oqu_ctl.sv 
wire                    dirrep_ic_dir_clear_c4;        // From dirrep of l5t_dirrep_ctl.sv 
wire [7:0]              ic_inv_mask_0145;       // From ic_ctl_0145 of l5t_dir_ctl.sv 
wire [7:0]              ic_inv_mask_2367;       // From ic_ctl_2367 of l5t_dir_ctl.sv 
wire [7:0]              ic_inv_mask_89cd;       // From ic_ctl_89cd of l5t_dir_ctl.sv 
wire [7:0]              ic_inv_mask_abef;       // From ic_ctl_abef of l5t_dir_ctl.sv 
wire [3:0]              dirrep_ic_lkup_panel_dec_c4;   // From dirrep of l5t_dirrep_ctl.sv 
wire [3:0]              dirrep_ic_lkup_row_dec_c4;     // From dirrep of l5t_dirrep_ctl.sv 
wire [15:0]             ic_lkup_wr_data_c4_row0;// From ic_buf_row0 of l5t_dirlbf_dp.sv, BS and SR 11/18/03 Reverse Directory change 
wire [15:0]             ic_lkup_wr_data_c4_row2;// From ic_buf_row1 of l5t_dirlbf_dp.sv, BS and SR 11/18/03 Reverse Directory change 
wire [2:0]              ic_parity_in;           // From out_col0 of l5t_dirout_dp.sv, ... 
wire [3:0]              ic_parity_out;          // From out_col3 of l5t_dirout_dp.sv, ... 
...
wire                    dirrep_ic_rd_en_c4;            // From dirrep of l5t_dirrep_ctl.sv 
wire [3:0]              dirrep_ic_rdwr_panel_dec_c4;   // From dirrep of l5t_dirrep_ctl.sv 
wire [3:0]              dirrep_ic_rdwr_row_en_c4;      // From dirrep of l5t_dirrep_ctl.sv 
wire [5:0]              ic_rw_addr_0145;        // From ic_ctl_0145 of l5t_dir_ctl.sv , BS and SR 11/18/03 Reverse Directory change
wire [5:0]              ic_rw_addr_2367;        // From ic_ctl_2367 of l5t_dir_ctl.sv , BS and SR 11/18/03 Reverse Directory change
wire [5:0]              ic_rw_addr_89cd;        // From ic_ctl_89cd of l5t_dir_ctl.sv , BS and SR 11/18/03 Reverse Directory change
wire [5:0]              ic_rw_addr_abef;        // From ic_ctl_abef of l5t_dir_ctl.sv , BS and SR 11/18/03 Reverse Directory change
wire                    ic_warm_rst_0145;       // From ic_ctl_0145 of l5t_dir_ctl.sv 
wire                    ic_warm_rst_89cd;       // From ic_ctl_89cd of l5t_dir_ctl.sv 
wire                    dirrep_ic_wr_en_c4;            // From dirrep of l5t_dirrep_ctl.sv 
//wire                    arbadr_idx_c1c4comp_c1;        // From arbadr of l5t_arbadr_dp.sv 
//wire                    arbadr_idx_c1c5comp_c1;        // From arbadr of l5t_arbadr_dp.sv 
wire                    arb_inc_tag_ecc_cnt_c3_n;   // From arb of l5t_arb_ctl.sv 
wire [7:0]              dirrep_inval_mask_dcd_c4;      // From dirrep of l5t_dirrep_ctl.sv 
wire [7:0]              dirrep_inval_mask_icd_c4;      // From dirrep of l5t_dirrep_ctl.sv 
wire                    tagdp_invalid_evict_c3;       // From tagdp of l5t_tagdp_ctl.sv 
wire                    ique_iq_arb_atm_px2;      // From ique of l5t_ique_dp.sv 
wire                    ique_iq_arb_csr_px2;      // From ique of l5t_ique_dp.sv 
wire                    ique_iq_arb_st_px2;       // From ique of l5t_ique_dp.sv 
wire                    ique_iq_arb_vbit_px2;     // From ique of l5t_ique_dp.sv 
wire                    iqu_iq_arb_vld_px2;      // From iqu of l5t_iqu_ctl.sv 
wire [39:0]             ique_iq_arbdp_addr_px2;      // From ique of l5t_ique_dp.sv 
wire [63:0]             ique_iq_arbdp_data_px2;      // From ique of l5t_ique_dp.sv 
wire [24:0]             ique_iq_arbdp_inst_px2;      // From ique of l5t_ique_dp.sv // BS and SR 11/12/03 N2 Xbar Packet format
wire                    iqu_sel_c1;           // From iqu of l5t_iqu_ctl.sv 
wire                    iqu_sel_pcx;          // From iqu of l5t_iqu_ctl.sv 
//wire                    rdmat_sii_req_vld_buf;        // From rdmat of l5t_rdmat_ctl.sv 
wire                    csr_l2_bypass_mode_on;      // From csr of l5t_csr_ctl.sv 
//wire                    csr_l2_dbg_en;              // From csr of l5t_csr_ctl.sv 
wire                    csr_l2_dir_map_on;          // From csr of l5t_csr_ctl.sv 
wire                    csreg_tagdp_l2_dir_map_on;  // From csreg of l5t_csreg_ctl.sv
wire                    csreg_misbuf_l2_dir_map_on;  // From csreg of l5t_csreg_ctl.sv
wire                    csreg_filbuf_l2_dir_map_on;  // From csreg of l5t_csreg_ctl.sv

wire [5:0]              csr_l2_steering_tid;        // From csr of l5t_csr_ctl.sv, BS and SR 11/12/03 N2 Xbar Packet format 
wire [27:0]             decc_lda_syndrome_c9;        // From decc of l5t_decc_dp.sv 
wire [`TAG_WIDTH_LESS1:1]   tagd_lkup_tag_c1;            // From tagd of l5t_tagd_dp.sv 


wire [15:0]             vuaddp_lru_way_c3;             // From vuaddp of l5t_vuaddp_ctl.sv 
wire [15:0]             tagdp_lru_way_sel_c3;         // From tagdp of l5t_tagdp_ctl.sv 
wire [127:0]            mb_data_read_data;      // From mbdata of lib_r_rf16x128d_cust.sv 
wire                    misbuf_arb_mcurd_en;    // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_arb_l2rd_en;      // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_arb_cnt28_px2_prev;// From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_arb_snp_cnt8_px1;// From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_arb_vld_px1;   // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_arbdp_ctrue_px2;  // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_buf_rd_en;        // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_corr_err_c2;      // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_filbuf_mcu_pick;  // From misbuf of l5t_misbuf_ctl.sv 
wire [2:0]              misbuf_filbuf_fbid;       // From misbuf of l5t_misbuf_ctl.sv 
wire [4:0]              misbuf_filbuf_next_link_c4;// From misbuf of l5t_misbuf_ctl.sv, BS & SR 11/04/03, MB grows to 32
 
wire                    misbuf_filbuf_next_vld_c4;// From misbuf of l5t_misbuf_ctl.sv 
wire [3:0]              misbuf_filbuf_way;        // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_filbuf_way_fbid_vld;// From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_hit_c3;           // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_hit_c4;           // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_nondep_fbhit_c3;  // From misbuf of l5t_misbuf_ctl.sv 
wire                    tag_misbuf_rdma_reg_vld_c2;  // From tag of l5t_tag_ctl.sv 
wire                    misbuf_tag_hit_unqual_c2;// From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_uncorr_err_c2;    // From misbuf of l5t_misbuf_ctl.sv 
wire [4:0]              misbuf_wbuf_mbid_c4;    // From misbuf of l5t_misbuf_ctl.sv, BS & SR 11/04/03, MB grows to 32  
wire                    misbuf_wr64_miss_comp_c3;// From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_mbf_delete_c4;          // From misbuf of l5t_misbuf_ctl.sv 
wire                    misbuf_mbf_insert_c4;          // From misbuf of l5t_misbuf_ctl.sv 
wire [4:0]              misbuf_mbf_insert_mbid_c4;     // From misbuf of l5t_misbuf_ctl.sv, BS & SR 11/04/03, MB grows to 32 
wire                    mbist_arb_l2d_en;       // From mbist of l5t_mbist_ctl.sv 
wire                    mbist_arb_l5t_write;    // From mbist of l5t_mbist_ctl.sv
wire                    mbist_arb_l2d_write;    // From mbist of l5t_mbist_ctl.sv 
wire                    mbist_l2d_en;           // From mbist of l5t_mbist_ctl.sv 
wire [8:0]              mbist_l2d_index;        // From mbist of l5t_mbist_ctl.sv 
wire [3:0]              mbist_l2d_way;          // From mbist of l5t_mbist_ctl.sv 
wire [3:0]              mbist_l2d_word_sel;     // From mbist of l5t_mbist_ctl.sv 
wire                    mbist_l2d_write;        // From mbist of l5t_mbist_ctl.sv 
wire [15:0]             mbist_l5t_dec_way;      // From mbist of l5t_mbist_ctl.sv 
wire [15:0]             tagd_mbist_l5t_dec_way_buf;  // From tagd of l5t_tagd_dp.sv 
wire [8:0]              mbist_l5t_index;        // From mbist of l5t_mbist_ctl.sv 
wire [8:0]              tagd_mbist_l5t_index_buf;    // From tagd of l5t_tagd_dp.sv 
wire                    mbist_l5t_read;         // From mbist of l5t_mbist_ctl.sv 
wire                    tagd_mbist_l5t_read_buf;     // From tagd of l5t_tagd_dp.sv 
wire [3:0]              mbist_l5t_way;          // From mbist of l5t_mbist_ctl.sv 
wire                    mbist_l5t_write;        // From mbist of l5t_mbist_ctl.sv 
wire                    tagd_mbist_l5t_write_buf;    // From tagd of l5t_tagd_dp.sv 
wire [8:0]              mbist_l2v_index;        // From mbist of l5t_mbist_ctl.sv 
wire                    mbist_l2v_read;         // From mbist of l5t_mbist_ctl.sv 
wire                    mbist_l2v_vd;           // From mbist of l5t_mbist_ctl.sv 
wire                    mbist_l2v_write;        // From mbist of l5t_mbist_ctl.sv 
wire                    mbist_stop_on_next_fail;// From test_stub of test_stub_bist.v 
wire [7:0]              mbist_write_data;       // From mbist of l5t_mbist_ctl.sv 
wire [7:0]              tagd_mbist_write_data_buf;   // From tagd of l5t_tagd_dp.sv 
wire [3:0]              csreg_mux1_addr_sel;          // From csreg of l5t_csreg_ctl.sv 
wire [3:0]              mux1_h_sel_r0;          // From vuad of l5t_vuad_dp.sv 
wire [3:0]              mux1_h_sel_r2;          // From vuad of l5t_vuad_dp.sv 
wire [3:0]              mux1_l_sel_r0;          // From vuad of l5t_vuad_dp.sv 
wire [3:0]              mux1_l_sel_r2;          // From vuad of l5t_vuad_dp.sv 
wire                    arb_mux1_mbsel_px1;         // From arb of l5t_arb_ctl.sv 
wire                    arb_mux1_mbsel_px2;         // From arb of l5t_arb_ctl.sv 
wire [3:0]              oqu_mux1_sel_data_c7;       // From oqu of l5t_oqu_ctl.sv 
wire [1:0]              csreg_mux1_synd_sel;          // From csreg of l5t_csreg_ctl.sv 
wire [2:0]              csreg_mux2_addr_sel;          // From csreg of l5t_csreg_ctl.sv 
wire                    vuad_mux2_sel_r0;            // From vuad of l5t_vuad_dp.sv 
wire                    vuad_mux2_sel_r2;            // From vuad of l5t_vuad_dp.sv 
wire [1:0]              csreg_mux2_synd_sel;          // From csreg of l5t_csreg_ctl.sv 
//wire                    arb_mux3_bufsel_px2;        // From arb of l5t_arb_ctl.sv 
wire                    oqu_mux_csr_sel_c7;         // From oqu of l5t_oqu_ctl.sv 
wire [1:0]              vuad_mux_sel;                // From vuad of l5t_vuad_dp.sv 
wire [3:0]              oqu_mux_vec_sel_c6;         // From oqu of l5t_oqu_ctl.sv 
wire                    csr_oneshot_dir_clear_c3;   // From csr of l5t_csr_ctl.sv 
wire                    oqu_arb_full_px2;  // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_cerr_ack_c7;      // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_diag_acc_c8;      // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_imiss_hit_c8;     // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_int_ack_c7;       // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_l2_miss_c7;       // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_pf_ack_c7;        // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_rmo_st_c7;        // From oqu of l5t_oqu_ctl.sv 
wire [3:0]              oqu_rqtyp_rtn_c7;     // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_st_complete_c7;   // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_uerr_ack_c7;      // From oqu of l5t_oqu_ctl.sv 
wire [5:0]              oque_tid_c8;            // From oque of l5t_oque_dp.sv, BS and SR 11/12/03 N2 Xbar Packet format change 
wire                    rdmat_or_rdmat_valid;         // From rdmat of l5t_rdmat_ctl.sv 
wire [2:0]              oqu_out_mux1_sel_c7;        // From oqu of l5t_oqu_ctl.sv 
wire [2:0]              oqu_out_mux2_sel_c7;        // From oqu of l5t_oqu_ctl.sv 

wire			vuadpm_vd_ue_c4;
wire			vuadpm_ua_ue_c4;

wire                    iqu_pcx_l5t_atm_px2_p;    // From iqu of l5t_iqu_ctl.sv 
wire [4:0]              vuad_rd_addr1_r0;            // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_rd_addr1_r1;            // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_rd_addr1_r2;            // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_rd_addr1_r3;            // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_rd_addr2_r0;            // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_rd_addr2_r1;            // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_rd_addr2_r2;            // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_rd_addr2_r3;            // From vuad of l5t_vuad_dp.sv 
wire                    vuad_rd_addr_sel_r0;         // From vuad of l5t_vuad_dp.sv 
wire                    vuad_rd_addr_sel_r1;         // From vuad of l5t_vuad_dp.sv 
wire                    vuad_rd_addr_sel_r2;         // From vuad of l5t_vuad_dp.sv 
wire                    vuad_rd_addr_sel_r3;         // From vuad of l5t_vuad_dp.sv 
wire                    vuad_rd_en_r0;               // From vuad of l5t_vuad_dp.sv 
wire                    vuad_rd_en_r1;               // From vuad of l5t_vuad_dp.sv 
wire                    vuad_rd_en_r2;               // From vuad of l5t_vuad_dp.sv 
wire                    vuad_rd_en_r3;               // From vuad of l5t_vuad_dp.sv 
wire [1:0]              snp_rdmad_wr_entry_s2;      // From snp of l5t_snp_ctl.sv 
wire [39:6]             arbadr_rdmard_addr_c12;        // From arbadr of l5t_arbadr_dp.sv 
wire                    rdmat_rdmard_cerr_c12;        // From rdmat of l5t_rdmat_ctl.sv 
wire                    rdmat_rdmard_uerr_c12;        // From rdmat of l5t_rdmat_ctl.sv 
wire [3:0]              rdmat_pick_vec;         // From rdmat of l5t_rdmat_ctl.sv 
wire [1:0]              rdmat_wr_entry_s1;      // From rdmat of l5t_rdmat_ctl.sv 
wire                    rdmat_hit_unqual_c2; // From rdmat of l5t_rdmat_ctl.sv 
wire [4:0]              rdmat_misbuf_dep_mbid;// From rdmat of l5t_rdmat_ctl.sv, BS & SR 11/04/03, MB grows to 32 
wire                    rdmat_misbuf_dep_rdy_en;// From rdmat of l5t_rdmat_ctl.sv 
wire [3:0]              wbuf_reset_rdmat_vld;        // From wbuf of l5t_wbuf_ctl.sv 
wire [127:0]            retbuf_ret_data_c7;          // From retbuf2 of l5t_retbuf_dp.sv 
wire [127:0]            decc_ret_data_c8;          // From decc of l5t_decc_dp.sv 
wire [38:0]             decc_ret_diag_data_c7;     // From decc of l5t_decc_dp.sv 
wire [27:0]             retbuf_ret_ecc_c7;           // From retbuf2 of l5t_retbuf_dp.sv 
wire [2:0]              deccck_ret_err_c8;           // From deccck of l5t_deccck_ctl.sv 
wire [15:0]             tag_l2b_fbwr_wen_r2;      // From tag of l5t_tag_ctl.sv 
wire [3:0]              tag_scrub_addr_way;         // From tag of l5t_tag_ctl.sv 
wire                    oqu_sel_array_out_l;        // From oqu of l5t_oqu_ctl.sv 
wire                    iqu_sel_c1reg_over_iqarray; // From iqu of l5t_iqu_ctl.sv 
wire                    arb_sel_c2_stall_idx_c1;    // From arb of l5t_arb_ctl.sv 
wire                    arb_sel_deccck_addr_px2;      // From arb of l5t_arb_ctl.sv 
wire                    arb_sel_deccck_or_bist_idx;   // From arb of l5t_arb_ctl.sv 
wire                    vuaddp_sel_diag0_data_wr_c3;   // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    vuaddp_sel_diag1_data_wr_c3;   // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    arb_sel_diag_addr_px2;      // From arb of l5t_arb_ctl.sv 
wire                    arb_sel_diag_tag_addr_px2;  // From arb of l5t_arb_ctl.sv 
wire                    oqu_sel_inval_c7;           // From oqu of l5t_oqu_ctl.sv 
wire                    arb_sel_lkup_stalled_tag_px2;// From arb of l5t_arb_ctl.sv 
wire [3:0]              oqu_sel_mux1_c6;            // From oqu of l5t_oqu_ctl.sv 
wire [3:0]              oqu_sel_mux2_c6;            // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_sel_mux3_c6;            // From oqu of l5t_oqu_ctl.sv 
wire                    tag_sel_rdma_inval_vec_c5;  // From tag of l5t_tag_ctl.sv 
wire                    arb_sel_tecc_addr_px2;      // From arb of l5t_arb_ctl.sv 
wire                    vuaddp_sel_ua_wr_data_byp;     // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    vuaddp_sel_vd_wr_data_byp;     // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    arb_sel_vuad_bist_px2;      // From arb of l5t_arb_ctl.sv 
wire                    arb_sel_way_px2;            // From arb of l5t_arb_ctl.sv 
wire [3:0]              wbuf_set_rdmat_acked;        // From wbuf of l5t_wbuf_ctl.sv 
wire [1:0]              arbdec_size_field_c8;          // From arbdec of l5t_arbdec_dp.sv 
wire                    snp_data1_wen0_s2;      // From snp of l5t_snp_ctl.sv 
wire                    snp_data1_wen1_s2;      // From snp of l5t_snp_ctl.sv 
wire                    snp_data2_wen0_s3;      // From snp of l5t_snp_ctl.sv 
wire                    snp_data2_wen1_s3;      // From snp of l5t_snp_ctl.sv 
wire                    snp_hdr1_wen0_s0;       // From snp of l5t_snp_ctl.sv 
wire                    snp_hdr1_wen1_s0;       // From snp of l5t_snp_ctl.sv 
wire                    snp_hdr2_wen0_s1;       // From snp of l5t_snp_ctl.sv 
wire                    snp_hdr2_wen1_s1;       // From snp of l5t_snp_ctl.sv 
wire                    snp_rd_ptr;          // From snp of l5t_snp_ctl.sv 
wire                    snp_wr_ptr;          // From snp of l5t_snp_ctl.sv 
wire                    snpd_rq_winv_s1;       // From snpd of l5t_snpd_dp.sv 
wire                    snp_snpq_arb_vld_px1;    // From snp of l5t_snp_ctl.sv 
wire [39:0]             snpd_snpq_arbdp_addr_px2;    // From snpd of l5t_snpd_dp.sv 
wire [6:0]             snpd_ecc_px2;    // From snpd of l5t_snpd_dp.sv 
wire [63:0]             snpd_snpq_arbdp_data_px2;    // From snpd of l5t_snpd_dp.sv 
wire [`JBI_HDR_SZ_LESS1:0]  snpd_snpq_arbdp_inst_px2;    // From snpd of l5t_snpd_dp.sv 
wire                    tag_spc_rd_cond_c3;         // From tag of l5t_tag_ctl.sv 
//wire                    vuaddp_st_to_data_array_c3;    // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    arb_store_err_c8;           // From arb of l5t_arb_ctl.sv 
wire                    oqu_str_ld_hit_c7;          // From oqu of l5t_oqu_ctl.sv 
wire                    oqu_strst_ack_c7;           // From oqu of l5t_oqu_ctl.sv 
wire                    tagdp_tag_error_c8;           // From tagdp of l5t_tagdp_ctl.sv 
wire [15:0]             tagl_parity_c2;          // From tagl_1 of l5t_tagl_dp.sv, ... 
wire [3:0]              tagdp_quad_muxsel_c3;     // From tagdp of l5t_tagdp_ctl.sv 
wire [`TAG_WIDTH_LESS1:0]   tagl_quad0_c3;          // From tagl_1 of l5t_tagl_dp.sv 
wire [`TAG_WIDTH_LESS1:0]   tagl_quad1_c3;          // From tagl_1 of l5t_tagl_dp.sv 
wire [`TAG_WIDTH_LESS1:0]   tagl_quad2_c3;          // From tagl_2 of l5t_tagl_dp.sv 
wire [`TAG_WIDTH_LESS1:0]   tagl_quad3_c3;          // From tagl_2 of l5t_tagl_dp.sv 
wire [27:0]             tag_way0_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way10_tag_c2;       // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way11_tag_c2;       // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way1_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way2_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way3_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way4_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way5_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way6_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way7_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way8_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [27:0]             tag_way9_tag_c2;        // From tag of lib_r_l5t_cust.sv 
wire [15:0]             tag_way_sel_c2;         // From tag of lib_r_l5t_cust.sv 
wire [27:0]             arbadr_tag_wrdata_px2;         // From arbadr of l5t_arbadr_dp.sv 
wire [27:0]             tagd_wrdata_px2_buf;     // From tagd of l5t_tagd_dp.sv 
wire                    tag_bsc_rd_vld_c7;   // From tag of l5t_tag_ctl.sv 
wire                    tag_cerr_ack_c5;     // From tag of l5t_tag_ctl.sv 
wire                    tag_deccck_addr3_c7;   // From tag of l5t_tag_ctl.sv 
wire                    tag_deccck_data_sel_c8;// From tag of l5t_tag_ctl.sv 
wire                    tag_fwd_req_ld_c6;   // From tag of l5t_tag_ctl.sv 
wire                    tag_fwd_req_ret_c5;  // From tag of l5t_tag_ctl.sv 
wire                    tag_hit_c3;          // From tag of l5t_tag_ctl.sv 
wire                    tag_hit_c5;          // From tag of l5t_tag_ctl.sv 
wire                    tag_hit_l2orfb_c3;   // From tag of l5t_tag_ctl.sv 
wire                    tag_hit_not_comp_c3; // From tag of l5t_tag_ctl.sv 
wire                    tag_hit_unqual_c2;   // From tag of l5t_tag_ctl.sv 
wire [15:0]             tag_hit_way_vld_c3;  // From tag of l5t_tag_ctl.sv 
wire                    tag_imiss_hit_c5;    // From tag of l5t_tag_ctl.sv 
wire                    tag_inc_rdma_cnt_c4; // From tag of l5t_tag_ctl.sv 
wire                    tag_inst_mb_c5;      // From tag of l5t_tag_ctl.sv 
wire                    tag_int_ack_c5;      // From tag of l5t_tag_ctl.sv 
wire                    tag_siu_req_en_c52;   // From tag of l5t_tag_ctl.sv 
wire                    tag_ld_hit_c5;       // From tag of l5t_tag_ctl.sv 
wire [3:0]              tag_lru_way_c4;      // From tag of l5t_tag_ctl.sv 
wire                    tag_misbuf_par_err_c3;// From tag of l5t_tag_ctl.sv 
wire                    tag_miss_unqual_c2;  // From tag of l5t_tag_ctl.sv 
wire                    tag_nonmem_comp_c6;  // From tag of l5t_tag_ctl.sv 
wire                    tag_rd64_complete_c11;// From tag of l5t_tag_ctl.sv 
wire                    tag_rdma_ev_en_c4;   // From tag of l5t_tag_ctl.sv 
wire                    tag_rdma_gate_off_c2;// From tag of l5t_tag_ctl.sv 
wire                    tag_rdma_vld_px0_p;  // From tag of l5t_tag_ctl.sv 
wire                    tag_rdma_vld_px1;    // From tag of l5t_tag_ctl.sv 
wire                    tag_rdma_wr_comp_c4; // From tag of l5t_tag_ctl.sv 
wire                    tag_rmo_st_ack_c5;   // From tag of l5t_tag_ctl.sv 
wire                    tag_scrub_rd_vld_c7; // From tag of l5t_tag_ctl.sv 
wire                    tag_set_rdma_reg_vld_c4;// From tag of l5t_tag_ctl.sv 
wire                    tag_spc_rd_vld_c6;   // From tag of l5t_tag_ctl.sv 
wire                    tag_st_ack_c5;       // From tag of l5t_tag_ctl.sv 
wire                    tag_st_req_c5;       // From tag of l5t_tag_ctl.sv 
wire                    tag_st_to_data_array_c3;// From tag of l5t_tag_ctl.sv 
wire                    tag_store_inst_c5;   // From tag of l5t_tag_ctl.sv 
wire                    tag_strst_ack_c5;    // From tag of l5t_tag_ctl.sv 
wire                    tag_uerr_ack_c5;     // From tag of l5t_tag_ctl.sv 
wire                    tagdp_arb_par_err_c3;// From tagdp of l5t_tagdp_ctl.sv 
wire [`TAG_WIDTH_LESS1:0]   tagd_diag_data_c7;     // From tagd of l5t_tagd_dp.sv 
wire [`TAG_WIDTH_LESS1:0]   tagd_evict_tag_c4;     // From tagd of l5t_tagd_dp.sv 
wire                    tagdp_misbuf_par_err_c3; // From tagdp of l5t_tagdp_ctl.sv 
wire                    tagdp_tag_par_err_c3;// From tagdp of l5t_tagdp_ctl.sv 
wire [3:0]              tagdp_quad0_muxsel_c3;       // From tagdp of l5t_tagdp_ctl.sv 
wire [3:0]              tagdp_quad1_muxsel_c3;       // From tagdp of l5t_tagdp_ctl.sv 
wire [3:0]              tagdp_quad2_muxsel_c3;       // From tagdp of l5t_tagdp_ctl.sv 
wire [3:0]              tagdp_quad3_muxsel_c3;       // From tagdp of l5t_tagdp_ctl.sv 
wire                    tag_uerr_ack_tmp_c4;        // From tag of l5t_tag_ctl.sv 
wire [77:0]             vuad_array_rd_data_c1;  // From io_left of l5t_vuadio_dp.sv, ... 
wire [77:0]             vlddir_vuad_array_wr_data_c4;  // From vlddir of l5t_vlddir_dp.sv, ... 
wire                    vuaddp_vuad_array_wr_en0_c4;   // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    vuaddp_vuad_array_wr_en1_c4;   // From vuaddp of l5t_vuaddp_ctl.sv 
wire [15:0]             usaloc_vuad_alloc_c2;       // From usaloc of l5t_usaloc_dp.sv 
wire [15:0]             usaloc_vuad_used_c2;        // From usaloc of l5t_usaloc_dp.sv 
wire [15:0]             vlddir_vuad_valid_c2;       // From vlddir of l5t_vlddir_dp.sv 
wire                    vuaddp_vuad_error_c8;          // From vuaddp of l5t_vuaddp_ctl.sv 
wire [8:0]              evctag_vuad_idx_c3;            // From evctag of l5t_evctag_dp.sv 
wire [8:0]              vuaddp_vuad_idx_c4;            // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    vuaddp_vuad_sel_c2;            // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    vuaddp_vuad_sel_c2_d1;         // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    vuaddp_vuad_sel_c4;            // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    vuaddp_vuad_sel_rd;            // From vuaddp of l5t_vuaddp_ctl.sv 
wire	[6:0]		usaloc_ua_synd_c9;
wire	[6:0]		vlddir_vd_synd_c9;

wire                    vuaddp_vuad_tagd_sel_c2_d1;   // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    arb_vuadctl_no_bypass_px2;  // From arb of l5t_arb_ctl.sv 
wire                    wbuf_wb_or_rdma_wr_req_en;   // From wbuf of l5t_wbuf_ctl.sv 
wire                    wbuf_arb_full_px1;  // From wbuf of l5t_wbuf_ctl.sv 
wire                    wbuf_hit_unqual_c2;    // From wbuf of l5t_wbuf_ctl.sv 
wire [4:0]              wbuf_misbuf_dep_mbid;   // From wbuf of l5t_wbuf_ctl.sv, BS & SR 11/04/03, MB grows to 32 
wire                    wbuf_misbuf_dep_rdy_en; // From wbuf of l5t_wbuf_ctl.sv 
wire                    wbuf_wr_addr_sel;      // From wbuf of l5t_wbuf_ctl.sv 
wire [3:0]              vuad_word_en_r0;             // From vuad of l5t_vuad_dp.sv 
wire [3:0]              vuad_word_en_r1;             // From vuad of l5t_vuad_dp.sv 
wire [3:0]              vuad_word_en_r2;             // From vuad of l5t_vuad_dp.sv 
wire [3:0]              vuad_word_en_r3;             // From vuad of l5t_vuad_dp.sv 
wire                    arbdat_word_lower_cmp_c8;      // From arbdat of l5t_arbdat_dp.sv 
wire                    arbdat_word_upper_cmp_c8;      // From arbdat of l5t_arbdat_dp.sv 
wire                    vuaddp_wr64_inst_c3;           // From vuaddp of l5t_vuaddp_ctl.sv 
wire                    arb_wr8_inst_no_ctrue_c1;   // From arb of l5t_arb_ctl.sv 
wire [4:0]              vuad_wr_addr_r0;             // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_wr_addr_r1;             // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_wr_addr_r2;             // From vuad of l5t_vuad_dp.sv 
wire [4:0]              vuad_wr_addr_r3;             // From vuad of l5t_vuad_dp.sv 
wire [4:0]              dirrep_wr_dc_dir_entry_c4;     // From dirrep of l5t_dirrep_ctl.sv, BS and SR 11/18/03 Reverse Directory change 
wire                    vuad_wr_en_r0c0;             // From vuad of l5t_vuad_dp.sv 
wire                    vuad_wr_en_r0c1;             // From vuad of l5t_vuad_dp.sv 
wire                    vuad_wr_en_r1c0;             // From vuad of l5t_vuad_dp.sv 
wire                    vuad_wr_en_r1c1;             // From vuad of l5t_vuad_dp.sv 
wire                    vuad_wr_en_r2c0;             // From vuad of l5t_vuad_dp.sv 
wire                    vuad_wr_en_r2c1;             // From vuad of l5t_vuad_dp.sv 
wire                    vuad_wr_en_r3c0;             // From vuad of l5t_vuad_dp.sv 
wire                    vuad_wr_en_r3c1;             // From vuad of l5t_vuad_dp.sv 
//wire                    csreg_wr_enable_async_c9;     // From csreg of l5t_csreg_ctl.sv 
wire                    csreg_wr_enable_tid_c9;       // From csreg of l5t_csreg_ctl.sv 
wire [4:0]              dirrep_wr_ic_dir_entry_c4;     // From dirrep of l5t_dirrep_ctl.sv, BS and SR 11/18/03 Reverse Directory change 
...
n2_l5t_sp_28kb_cust		tag(
.bist_index0                    (tagd_mbist_l5t_index_buf[8:0]),
.bist_index1                    (tagd_mbist_l5t_index_buf[8:0]),
.bist_rd_en0                    (tagd_mbist_l5t_read_buf),
.bist_rd_en1                    (tagd_mbist_l5t_read_buf),
.bist_way                       (tagd_mbist_l5t_dec_way_buf[15:0]),
.bist_wr_en0                    (tagd_mbist_l5t_write_buf),
.bist_wr_en1                    (tagd_mbist_l5t_write_buf),
...
.hdr_l5t_rvalue			(l5t_tag_rvalue[5:0]),
.hdr_l5t_rid			(l5t_tag_rid[3:0]),
.hdr_l5t_wr_en			(l5t_tag_wr_en),
.hdr_l5t_red_clr		(l5t_tag_fuse_clr),
// fuse
...
.l5t_bist_en0			(mbist_run),
.l5t_bist_en1			(mbist_run),
.wr_en_ov			(1'b1),
.clk_en0			(1'b1),
.clk_en1			(1'b1),
.clk_en_ov			(1'b1),
// outputs
.l5t_hdr_read_data              (tag_fuse_read_data[5:0]),   
...
l5t_tagdp_ctl	tagdp( 
			...
			.arb_pf_ice_inst_c2(arb_pf_ice_inst_c2),
                        ...
                        .vuaddp_vuad_tagd_sel_c2_d1(vuaddp_vuad_tagd_sel_c2_d1), 
                        .bist_way_px  (mbist_l5t_way[3:0]),    // Templated 
                        .bist_enable_px(mbist_l5t_read),       // Templated 
                        ...
                        .arb_l5tag_vld_c4(arb_l5tag_vld_c4), 
...
l5t_tagd_dp	tagd( 
			...
			.tcu_dectest(tcu_dectest),
                  ...
                  .tagd_diag_data_c7   (tagd_diag_data_c7[`TAG_WIDTH_LESS1:0]), 
                   ...
                   .tagd_mbist_l5t_index_buf  (tagd_mbist_l5t_index_buf[8:0]),  // BS & SR 10/28/03
                   .tagd_arb_tag_way_px2_buf(tagd_arb_tag_way_px2_buf[15:0]), // BS & SR 10/28/03 
                   .tagd_mbist_l5t_dec_way_buf(tagd_mbist_l5t_dec_way_buf[15:0]), // BS & SR 10/28/03 
                   .tagd_arb_tag_rd_px2_buf(tagd_arb_tag_rd_px2_buf), 
                   .tagd_mbist_l5t_read_buf   (tagd_mbist_l5t_read_buf), 
                   .tagd_arb_tag_wr_px2_buf(tagd_arb_tag_wr_px2_buf), 
                   .tagd_mbist_l5t_write_buf  (tagd_mbist_l5t_write_buf), 
                  ...
                  .arbadr_ncu_l5t_pm_n_dist(arbadr_tagd_ncu_l5t_pm_n_dist), // BS 03/25/04 for partial bank/core modes support
                  ...
                  .mbist_l5t_index      (mbist_l5t_index[8:0]),  // BS & SR 10/28/03
                  .arb_tag_way_px2   (arb_tag_way_px2[15:0]),  // BS & SR 10/28/03
                  .mbist_l5t_dec_way    (mbist_l5t_dec_way[15:0]), 
                  .arb_tag_rd_px2    (arb_tag_rd_px2), 
                  .mbist_l5t_read       (mbist_l5t_read), 
                  .arb_tag_wr_px2    (arb_tag_wr_px2), 
                  .mbist_l5t_write      (mbist_l5t_write), 
                  ...
                  .l2clk                 (l2clk),
  .mbist_l5tag_fail(mbist_l5tag_fail)); 
 

l5t_dmorpt_dp  dmorptr 
	(
	.in_bus0	(l5t_tcu_dmo_out_prev[38:0]),
	.in_bus1	(l5t_tcu_dmo_out_unbuff[38:0]),
	.out_bus0	(l5t_tcu_dmo_out_prev_buff[38:0]),
	.out_bus1	(l5t_tcu_dmo_out[38:0])
	);
 
l5t_dmo_dp 	dmologic (
	.tcu_l5t_coresel        (tcu_l5t_coresel),
	.l5t_tcu_dmo_out_prev   (l5t_tcu_dmo_out_prev_buff[38:0]),
	.scan_in(dmologic_scanin),
	.scan_out(dmologic_scanout),
	.l2clk                  (l2clk),
	.tcu_l5t_shscan_clk_stop_d2 	(tcu_l5t_shscan_clk_stop_d2),
	.tcu_l5t_shscan_clk_stop 	(tcu_l5t_shscan_clk_stop),
	.tcu_clk_stop           (1'b0),
	.tcu_pce_ov             (tcu_pce_ov),
	.tcu_aclk               (tcu_aclk),
	.tcu_bclk               (tcu_bclk),
	.tcu_scan_en            (tcu_scan_en),
	.l5t_tcu_dmo_out        (l5t_tcu_dmo_out_unbuff[38:0]),
...
l5t_mbist_ctl	mbist	( 
                // Outputs 
		.mbist_run(mbist_run),
                .mbist_done        (l5t_tcu_mbist_done), 
                .mbist_fail 	(l5t_tcu_mbist_fail), 
		.mbist_start_mb0(mbist_start_mb0),
		.mbist_start_mb2(mbist_start_mb2),
                // Inputs 
		.mbist0_done	(l5t_tcu_mbist0_done),
		.mbist2_done	(l5t_tcu_mbist2_done),
		.mbist0_fail	(l5t_tcu_mbist0_fail),
		.mbist2_fail	(l5t_tcu_mbist2_fail),
                .tcu_pce_ov(ce_ovrd),
                .tcu_aclk(aclk),
                .tcu_bclk(bclk),
		.tcu_scan_en(tcu_scan_en),
		.tcu_clk_stop(1'b0),
                ...
                .mbist_l5tag_index (mbist_l5t_index[8:0]),  // Templated 
                .mbist_l5tag_way   (mbist_l5t_way[3:0]),    // Templated 
                .mbist_l5tag_dec_way(mbist_l5t_dec_way[15:0]), // Templated 
                .mbist_l5tag_read  (mbist_l5t_read),        // Templated 
                .mbist_l5tag_write (mbist_l5t_write),       // Templated 
                ...
                .mbist_arb_l5t_write(mbist_arb_l5t_write),
                .mbist_arb_l2d_en  (mbist_arb_l2d_en), 
                .mbist_arb_l2d_write(mbist_arb_l2d_write), 
                .mbist_l2d_en      (mbist_l2d_en), 
                .scan_in(tcu_l5t_mbist_scan_in),
                .scan_out(tcu_l5t_mbist_scan_in1),
                .l2clk              (l2clk), 
                .mbist_start       (tcu_l5t_mbist_start), 
                .mbist_user_mode(tcu_mbist_user_mode), 
                .mbist_bisi_mode   (tcu_mbist_bisi_en), 
                .mbist_l5tag_hit_way   (tag_way_sel_c2_buff[15:0]),
                .mbist_l5tag_lkup_tag   (mbist_tag_lkup_addr[27:0]));
 
 
l5t_l2drpt_dp  l2drpt (
			.scan_in	(tagctl_scanin),
			.scan_out	(tagctl_scanin_1),
                        .tag_l2d_way_sel_c2(l5t_l2d_way_sel_c2[15:0]),
        		.tcu_clk_stop(1'b0),
                        .vlddir_vuad_valid_c2 (vlddir_vuad_valid_c2_rep1[15:0]), 
...
l5t_tag_ctl	tagctl ( 
			...
			.wmr_l		(wmr_l), 
                      ...
                      // .tag_l2d_col_offset_c2(l5t_l2d_col_offset_c2[3:0]), 
                       .tag_l2d_rd_wr_c2  (l5t_l2d_rd_wr_c2), 
                       .tag_l2d_word_en_c2(l5t_l2d_word_en_c2[15:0]), 
		...
		.filbuf_dis_nderr_c3	(filbuf_dis_nderr_c3[1:0]),
		  ...
		  .filbuf_tag_hit_frm_mb_c2(filbuf_tag_tag_hit_frm_mb_c2_rep),
 		      .filbuf_tag_evict_way_c3 (filbuf_tag_evict_way_c3_rep1[3:0]), // BS and SR 12/18/03, LRU way from Filbuf needs to be written to Dir on a Miss
                       .filbuf_mcu_l5t_chunk_id_r1(filbuf_mcu_l5t_chunk_id_r1[1:0]), 
                       .filbuf_mcu_l5t_data_vld_r1(filbuf_mcu_l5t_data_vld_r1), 
  ...
  .l5t_l2b_fbwr_wen_r2(l5t_l2b_fbwr_wen_r2[15:0]),
  .l5t_l2b_fbd_stdatasel_c3(l5t_l2b_fbd_stdatasel_c3),
  .tagctl_l2drpt_mux4_way_sel_c1(tagctl_l2drpt_mux4_way_sel_c1[15:0]),
...
l5t_misbuf_ctl	misbuf ( 
                                .tcu_pce_ov(ce_ovrd),
                                .tcu_aclk(aclk),
                                .tcu_bclk(bclk),
				.tcu_scan_en(tcu_scan_en),
        .l5t_mb2_mbdata_wr_en           (l5t_mb2_mbdata_wr_en),
        .l5t_mb2_mbdata_rd_en           (l5t_mb2_mbdata_rd_en),
        .l5t_mb2_mbtag_rd_en            (l5t_mb2_mbtag_rd_en),
        .l5t_mb2_mbtag_wr_en            (l5t_mb2_mbtag_wr_en),
        .l5t_mb2_addr                   (l5t_mb2_addr[4:0]),
		   ...
		   .misbuf_hit_st_dep_zero (misbuf_hit_st_dep_zero), // BS and SR 11/07/03, store pipelining support
                   ...
                   .l5t_mcu_rd_req   (l5t_mcu_rd_req), 
                   .l5t_mcu_rd_dummy_req(l5t_mcu_rd_dummy_req), 
  ...
  .misbuf_notdata_err_c1(misbuf_notdata_err_c1),
  .misbuf_uncorr_err_c1(misbuf_uncorr_err_c1),
  .l5t_mb2_run(l5t_mb2_run)); 
 
 
 
n2_l5t_dp_32x128_cust	mbdata( 
                       // Outputs 
...
l5t_filbuf_ctl	filbuf( 
                                .tcu_pce_ov(ce_ovrd),
                                .tcu_aclk(aclk),
                                .tcu_bclk(bclk),
		.tcu_scan_en(tcu_scan_en),
        .l5t_mb2_fbtag_wr_en            (l5t_mb2_fbtag_wr_en),
        .l5t_mb2_fbtag_rd_en            (l5t_mb2_fbtag_rd_en),
        .l5t_mb2_addr                   (l5t_mb2_addr[2:0]),
   ...
   .fb_mbist_cam_sel(mbist_cam_sel[1]),
	...
	.filbuf_dis_nderr_c3	(filbuf_dis_nderr_c3[1:0]),
		  ...
		  .filbuf_arb_tag_hit_frm_mb_c2(filbuf_arb_tag_hit_frm_mb_c2),
                  ...
                  .l5t_mcu_rd_req_id (l5t_mcu_rd_req_id[2:0]), 
                   .filbuf_fb_count_eq_0        (filbuf_fb_count_eq_0), 
                  .filbuf_misbuf_entry_avail(filbuf_misbuf_entry_avail), 
                  .filbuf_misbuf_match_c2 (filbuf_misbuf_match_c2), 
                  .filbuf_misbuf_fbid_d2  (filbuf_misbuf_fbid_d2[2:0]), 
                  ...
                  .filbuf_misbuf_nofill_d2(filbuf_misbuf_nofill_d2), 
                  .filbuf_misbuf_stinst_match_c2(filbuf_misbuf_stinst_match_c2), 
                   .filbuf_l2d_fb_hit_c3     (l5t_l2d_fb_hit_c3), 
                  .filbuf_vuad_bypassed_c3(filbuf_vuad_bypassed_c3), 
                  ...
                  // Inputs 
		   //.l5t_l2d_stdecc_c2(l5t_l2d_stdecc_c2[77:0]),
                   .misbuf_vuad_ce_err_c8(misbuf_vuad_ce_err_c8),
...
//                  .arb_filbuf_inst_vld_c2(arb_filbuf_inst_vld_c2), 
                  ...
                  .mcu_l5t_data_vld_r0(mcu_l5t_data_vld_r0), 
                  .mcu_l5t_rd_req_id_r0(mcu_l5t_rd_req_id_r0[2:0]), 
                  .mcu_l5t_chunk_id_r0(mcu_l5t_chunk_id_r0[1:0]), 
                  .mcu_l5t_secc_err_r2(mcu_l5t_secc_err_r2), 
                  .mcu_l5t_mecc_err_r2(mcu_l5t_mecc_err_r2), 
                  .mcu_l5t_scb_mecc_err(mcu_l5t_scb_mecc_err), 
                  .mcu_l5t_scb_secc_err(mcu_l5t_scb_secc_err), 
...
l5t_arbdat_dp	arbdat ( 
			    ...
			    .st_ack_data(st_ack_data[63:0]), // BS and SR 11/12/03 N2 Xbar Packet format change
                            ...
                            .arbdat_arbdp_store_data_c2(l5t_l2d_stdecc_c2[77:0]), 
			   ...
			   .arbdec_arbdp_inst_bufidhi_c1(arbdec_arbdp_inst_bufidhi_c1),
				...
				.l5t_mb2_wdata(l5t_mb2_wdata[7:0]),
				.misbuf_buf_rd_en(misbuf_buf_rd_en),
                           .misbuf_arb_l2rd_en(misbuf_arb_l2rd_en), 
...
l5t_arbadr_dp	arbadr ( 
				...
				.arbadr_csr_debug_addr	(arbadr_csr_debug_addr[33:2]),
                  	  ...
                  	  //  .arbadr_4bnk_true_enbld_dist(arbadr_4bnk_true_enbld_dist), // BS 03/25/04 for partial bank/core modes support
                          //  .arbadr_ncu_l5t_pm_n_dist(arbadr_ncu_l5t_pm_n_dist), // BS 03/25/04 for partial bank/core modes support
			...
			.arbadr_dirvec_ncu_l5t_pm_n_dist                 (arbadr_dirvec_ncu_l5t_pm_n_dist),
			...
			.arbadr_evctag_ncu_l5t_pm_n_dist                 (arbadr_evctag_ncu_l5t_pm_n_dist),
			...
			.arbadr_tagd_ncu_l5t_pm_n_dist                   (arbadr_tagd_ncu_l5t_pm_n_dist),
			...
			.arbadr_arbctl_ncu_l5t_pm_n_dist                 (arbadr_arbctl_ncu_l5t_pm_n_dist),
				...
				.arbadr_idx_c1c5comp_c1_n(arbadr_idx_c1c5comp_c1_n),
                           ...
                           // .arbadr_vuad_idx_c1c3comp_c1(arbadr_vuad_idx_c1c3comp_c1), 
                            ...
                            .arbadr_arbdp_addr3to2_c1(arbadr_arbdp_addr3to2_c1[1:0]), 
                            .arbadr_arbdp_diag_wr_way_c2(arbdp_diag_wr_way_c2[3:0]), 
                           .l5t_l2d_set_c2(l5t_l2d_set_c2[8:0]), // Templated 
                            .arbadr_arbaddr_addr22_c2(arbaddr_addr22_c2), 
                           ...
                           .arbadr_addr2_c8(arbadr_addr2_c8), 
                            ...
                            .arbadr_tag_wrdata_px2(arbadr_tag_wrdata_px2[27:0]), 
                           // Inputs 
                            .ncu_l5t_pm(ncu_l5t_pm), // BS 03/25/04 for partial bank/core modes support
                            .ncu_l5t_ba01(ncu_l5t_ba01), // BS 03/25/04 for partial bank/core modes support
                            .ncu_l5t_ba23(ncu_l5t_ba23), // BS 03/25/04 for partial bank/core modes support
                            .ncu_l5t_ba45(ncu_l5t_ba45), // BS 03/25/04 for partial bank/core modes support
                            .ncu_l5t_ba67(ncu_l5t_ba67), // BS 03/25/04 for partial bank/core modes support
                      .sel_diag_store_data_c7   (sel_diag_store_data_c7), // BS and SR 12/22/03, store ack generation for diagnostic store
			...
			.mb2_l5t_wk1_cam_init		(mb2_l5t_wk1_cam_init),
			.mb2_l5t_wk1_cam_shift		(mb2_l5t_wk1_cam_shift),
...
l5t_arb_ctl	arb( 
		...
		.wmr_l		(wmr_l), 
			...
			.arb_mux3_bufsel_px1	(arb_mux3_bufsel_px1),
                    ...
                    // .arb_filbuf_inst_vld_c2(arb_filbuf_inst_vld_c2), 
                     ...
                     .arb_evict_vld_c2(arb_evict_vld_c2), 
                     .arb_inst_diag_c1(arb_inst_diag_c1), 
                      .arb_l2d_fbrd_c3    (l5t_l2d_fbrd_c3), 
                     .arb_misbuf_ctrue_c9(arb_misbuf_ctrue_c9), 
                     .arb_misbuf_cas1_hit_c8(arb_misbuf_cas1_hit_c8), 
		     .arb_pf_ice_inst_c2(arb_pf_ice_inst_c2),
		     .arb_pf_ice_inst_c7(arb_pf_ice_inst_c7),
		...
		.ique_arb_pf_ice_px2 (ique_arb_pf_ice_px2),
                     ...
                     .arb_inst_l5tag_vld_c6(arb_inst_l5tag_vld_c6), 
                      .arb_decdp_tag_wr_c1(arb_decdp_tag_wr_c1), 
                      .arb_decdp_pst_inst_c2 (arb_decdp_pst_inst_c2), 
                      .arb_decdp_fwd_req_c2  (arb_decdp_fwd_req_c2), 
                      .arb_decdp_swap_inst_c2(arb_decdp_swap_inst_c2), 
			...
			//.arb_vuad_ce_err_c3 (arb_vuad_ce_err_c3),
                     ...
                     .arbadr_arbdp_addr87_c2(arbadr_arbdp_addr87_c2[1:0]), // BS 03/25/04 for partial bank/core modes support
                     .arbadr_ncu_l5t_pm_n_dist(arbadr_arbctl_ncu_l5t_pm_n_dist), // BS 03/25/04 for partial bank/core modes support
		     ...
		     .l5t_mb2_mbtag_lookup_en(l5t_mb2_mbtag_lookup_en),
		     .l5t_mb2_fbtag_lookup_en(l5t_mb2_fbtag_lookup_en),
		     .l5t_mb2_wbtag_lookup_en(l5t_mb2_wbtag_lookup_en),
		     .l5t_mb2_rdmatag_lookup_en(l5t_mb2_rdmatag_lookup_en),
		     .l5t_mb2_run(l5t_mb2_run),
                     .filbuf_arb_vld_px1(filbuf_arb_vld_px1), 
...
l5t_arbdec_dp	arbdec( 
	 		 ...
	 		 /*AUTOINST*/ 
                         // Outputs 
			  .l5t_dbg_xbar_vcid	(l5t_dbg_xbar_vcid_transfer[5:0]),
...
l5t_wbufrpt_dp wbufrpt (
  ...
  .tcu_bclk(tcu_bclk),
  .tcu_scan_en(tcu_scan_en),
  .l5t_l2b_wbrd_en_r0(l5t_l2b_wbrd_en_r0),
  .l5t_l2b_rdma_rden_r0(l5t_l2b_rdma_rden_r0),
  ...
  .mcu_l5t_wr_ack_d1(mcu_l5t_wr_ack_d1)
		);
...
l5t_wbuf_ctl	wbuf( 
        ...
        .l5t_mb2_rdmatag_rd_en          (l5t_mb2_rdmatag_rd_en),
        .l5t_mb2_wbtag_wr_en            (l5t_mb2_wbtag_wr_en),
        .l5t_mb2_wbtag_rd_en            (l5t_mb2_wbtag_rd_en),
        .l5t_mb2_addr                   (l5t_mb2_addr[2:0]),
		...
		.wb_mbist_cam_hit	(wb_mbist_cam_hit),
			...
			.wmr_l		(wmr_l), 
                  // Outputs 
		.l5t_dbg_sii_wib_dequeue (l5t_dbg_sii_wib_dequeue),
                  .l5t_l2b_wbwr_wl_c6(l5t_l2b_wbwr_wl_c6[2:0]), 
                  .l5t_l2b_wbwr_wen_c6(l5t_l2b_wbwr_wen_c6[3:0]), 
                  .l5t_l2b_wbrd_wl_r0(l5t_l2b_wbrd_wl_r0[2:0]), 
                 // .l5t_l2b_wbrd_en_r0(l5t_l2b_wbrd_en_r0), 
                  .l5t_l2b_ev_dword_r0(l5t_l2b_ev_dword_r0[2:0]), 
                  .l5t_l2b_evict_en_r0(l5t_l2b_evict_en_r0), 
                  .l5t_mcu_wr_req    (l5t_mcu_wr_req), 
                  .wbuf_hit_unqual_c2  (wbuf_hit_unqual_c2), 
                  .wbuf_misbuf_dep_rdy_en(wbuf_misbuf_dep_rdy_en), 
                  .wbuf_misbuf_dep_mbid (wbuf_misbuf_dep_mbid[4:0]), 
                  .wbuf_arb_full_px1(wbuf_arb_full_px1), 
                  ...
                  .l5t_l2b_rdma_rdwl_r0(l5t_l2b_rdma_rdwl_r0[1:0]), 
                 // .l5t_l2b_rdma_rden_r0(l5t_l2b_rdma_rden_r0), 
                   .wbuf_reset_rdmat_vld      (wbuf_reset_rdmat_vld[3:0]), 
                   .wbuf_set_rdmat_acked      (wbuf_set_rdmat_acked[3:0]), 
                  .l5t_sii_wib_dequeue(l5t_sii_wib_dequeue), 
                  // Inputs 
		.l5t_siu_delay			(l5t_siu_delay),
                  .scan_in(wbuf_scanin),
...
l5t_ique_dp	ique( 
		...
		.ique_arb_pf_ice_px2 (ique_arb_pf_ice_px2),
		  /*AUTOINST*/ 
                 // Outputs 
                  .ique_pcx_l5t_data_103_px2  (ique_pcx_l5t_data_103_px2),
                  .ique_iq_arbdp_data_px2     (ique_iq_arbdp_data_px2[63:0]), 
                  .ique_iq_arbdp_addr_px2     (ique_iq_arbdp_addr_px2[39:0]), 
                  .ique_iq_arbdp_inst_px2     (ique_iq_arbdp_inst_px2[24:0]), // BS and SR 11/12/03 N2 Xbar Packet format
                  .ique_iq_arb_atm_px2     (ique_iq_arb_atm_px2), 
                 ...
                 .l2clk                  (l2clk), 
             .pcx_l5t_data_px2    (pcx_l5t_data_px2[`PCX_WIDTH_LESS1:0]), // BS and SR 11/12/03 N2 Xbar Packet format change 
                  .iqu_pcx_l5t_atm_px2_p   (iqu_pcx_l5t_atm_px2_p), 
  ...
  .pcx_l5t_data_px2_fnl(pcx_l5t_data_px2_fnl[129:0])); 
...
l5t_iqu_ctl	iqu( 
                 ...
                 .tcu_bclk(bclk),
		.tcu_scan_en(tcu_scan_en),
		.l5t_mb2_iqarray_wr_en          (l5t_mb2_iqarray_wr_en),
		.l5t_mb2_iqarray_rd_en          (l5t_mb2_iqarray_rd_en),
		.l5t_mb2_run			(l5t_mb2_run),
		.l5t_mb2_addr			(l5t_mb2_addr[3:0]),
		...
		.wmr_l		(wmr_l), 
                // Outputs 
                .l5t_pcx_stall_pq   (l5t_pcx_stall_pq), 
                .iqu_iq_arb_vld_px2    (iqu_iq_arb_vld_px2), 
                .iqu_pcx_l5t_atm_px2_p  (iqu_pcx_l5t_atm_px2_p), 
                .iqu_sel_pcx        (iqu_sel_pcx), 
                .iqu_sel_c1         (iqu_sel_c1), 
                ...
                .l2clk                 (l2clk), 
                .pcx_l5t_data_rdy_px1(pcx_l5t_data_rdy_px1), 
                .pcx_l5t_atm_px1    (pcx_l5t_atm_px1), 
                .arb_iqsel_px2     (arb_iqsel_px2),
  .arb_iqsel_px2_v1(arb_iqsel_px2_v1),
  .iqu_iq_arb_vld_px2_v1(iqu_iq_arb_vld_px2_v1)); 
...
n2_l5t_dp_16x160_cust    iqarray( 
                           // Outputs 
        .dout        (iq_array_rd_data_c1[159:0]), 
                     // Inputs 
	.din ({29'b0,iqu_pcx_l5t_atm_px2_p,pcx_l5t_data_px2_fnl[`PCX_WIDTH_LESS1:104],
		     ique_pcx_l5t_data_103_px2, pcx_l5t_data_px2_fnl[102:0]}), 
          // BS and SR 11/12/03 N2 Xbar Packet format change 
//        .din ({29'b0,iqu_pcx_l5t_atm_px2_p,pcx_l5t_data_px2[`PCX_WIDTH_LESS1:0]}),
        .tcu_pce_ov(ce_ovrd),
        .pce(1'b1),
        .tcu_aclk(aclk),
        .tcu_bclk(bclk),
  	.tcu_scan_en(tcu_scan_en),
        ...
        .l2clk      (l2clk), 
        .tcu_array_wr_inhibit(array_wr_inhibit), 
        .mbist_wdata		(l5t_mb2_wdata[7:0]),
	.mbist_run		(l5t_mb2_run),
        .tcu_se_scancollar_in      (tcu_se_scancollar_in)); 
...
l5t_oqu_ctl		oqu( 
		    ...
		    .oqu_mmu_ld_hit_c7(oqu_mmu_ld_hit_c7), // BS and SR 11/12/03 N2 Xbar Packet format change
                    .l5t_cpx_req_cq   (l5t_cpx_req_cq[7:0]), 
                    .l5t_cpx_atom_cq  (l5t_cpx_atom_cq), 
		    ...
		    .misbuf_vuad_ce_err_c6(misbuf_vuad_ce_err_c6), // vuad ecc change
		     ...
		     .arb_cpuid_c5          (arb_cpuid_c5[2:0]),
        	    ...
        	    .l5t_mb0_addr                   (l5t_mb0_addr[3:0]),
                    ...
                    .arb_inst_l2vuad_vld_c6(arb_inst_l2vuad_vld_c6), 
                    .arb_csr_rd_en_c7(arb_csr_rd_en_c7), 
                    .cpx_l5t_grant_cx (cpx_l5t_grant_cx[7:0]), 
                    .scan_in(oqu_scanin),
                    .scan_out(oqu_scanout),
                    .l2clk               (l2clk),
  .l5t_mb0_run(l5t_mb0_run),
  .l5t_mb0_oqarray_rd_en(l5t_mb0_oqarray_rd_en),
  .l5t_mb0_oqarray_wr_en(l5t_mb0_oqarray_wr_en)); 
 
 



n2_l5t_dp_16x160_cust    oqarray( 
                           // Outputs 
		...
		.tcu_scan_en(tcu_scan_en),
                ...
                .l2clk      (l2clk),
        .mbist_wdata            (mb0_l5t_mbist_write_data[7:0]),
        .mbist_run           (l5t_mb0_run),
                           .tcu_se_scancollar_in      (tcu_se_scancollar_in)); 
...
l5t_oque_dp		oque( 
		...
		.tcu_clk_stop(1'b0),
			...
			.tcu_dectest(tcu_dectest),
                ...
                // Outputs 
                .l5t_cpx_data_ca   (l5t_cpx_data_ca[`CPX_WIDTH_LESS1:0]), 
		...
		.csr_report_ldrc	(csr_report_ldrc),
                ...
                .arbadr_arbdp_oque_l1_index_c7(arbadr_arbdp_oque_l1_index_c7[11:6]), 
                .oqu_imiss_hit_c8  (oqu_imiss_hit_c8), 
		.mb0_l5t_mbist_write_data(mb0_l5t_mbist_write_data[7:0]),
...
l5t_dirvec_ctl		dirvec( 
	...
	.tcu_clk_stop(1'b0),
        ...
        // Inputs 
			...
			.arbadr_ncu_l5t_pm_n_dist                 (arbadr_dirvec_ncu_l5t_pm_n_dist),
	    .sel_st_ack_c7(sel_st_ack_c7), // BS and SR 11/12/03 N2 Xbar Packet format change
	    ...
	    .mb0_l5t_cambist(mb0_l5t_cambist),
...
l5t_decc_dp		decc
		...
		.deccck_notdata_err_c8 (deccck_notdata_err_c8),
                ...
                .filbuf_spc_uncorr_err_c6(filbuf_spc_uncorr_err_c6), 
                .filbuf_spc_corr_err_c6(filbuf_spc_corr_err_c6), 
		.tcu_l5t_tag_or_data_sel(tcu_l5t_tag_or_data_sel),
		.decc_ret_diag_data_c7  (decc_ret_diag_data_c7[38:0]),
		...
		.mbist_write_data (mbist_write_data_decck[7:0]),
  		...
  		.l2d_l5t_decc_c6	(l2d_l5t_decc_c6[155:0]),
                .scan_in(decc_scanin),
...
// 
// l5t_shdwscn_dp block should not be hooked up to the main scan chain
//
l5t_shdwscn_dp	shadow_scan	
	(
	.tcu_l5t_shscan_scan_in		(tcu_l5t_shscan_scan_in	),
	.tcu_l5t_shscan_aclk		(tcu_l5t_shscan_aclk	),
	.tcu_l5t_shscan_bclk   		(tcu_l5t_shscan_bclk   	),
	.tcu_l5t_shscan_scan_en 	(tcu_l5t_shscan_scan_en ),
	.tcu_l5t_shscan_pce_ov		(tcu_l5t_shscan_pce_ov	),
	.tcu_l5t_shscan_clk_stop_d2 	(tcu_l5t_shscan_clk_stop_d2),
	.l5t_tcu_shscan_scan_out	(l5t_tcu_shscan_scan_out),
...
l5t_csr_ctl	csr ( 
		...
		.wmr_protect(wmr_protect),
               // Outputs 
		.arbadr_csr_debug_addr	(arbadr_csr_debug_addr[33:2]),
		.l5t_dbg_err_event (l5t_dbg_err_event),
		.csr_report_ldrc (csr_report_ldrc),
		.l5t_dbg_pa_match  (l5t_dbg_pa_match),
...
l5t_csreg_ctl	csreg ( 
			...
			.csreg_csr_rd_mux_fnl_c7	(csreg_csr_rd_mux_fnl_c7[1:0]),
                        ...
                        .csreg_csr_rd_mux3_sel_c7(csreg_csr_rd_mux3_sel_c7[1:0]), 
                        .csreg_csr_bist_wr_en_c8(csreg_csr_bist_wr_en_c8), 
                        .l5t_rst_fatal_error(l5t_rst_fatal_error),
                       // Inputs 
                	.csreg_l2_cmpr_reg_wr_en_c8     (csreg_l2_cmpr_reg_wr_en_c8),
                	.csreg_l2_mask_reg_wr_en_c8     (csreg_l2_mask_reg_wr_en_c8),
		       .misbuf_vuad_ce_err_c8(misbuf_vuad_ce_err_c8),
...
l5t_snp_ctl     snp( 
                // Outputs 
                .l5t_sii_iq_dequeue             (l5t_sii_iq_dequeue), 
                .snp_snpq_arb_vld_px1           (snp_snpq_arb_vld_px1), 
		.l5t_dbg_sii_iq_dequeue		(l5t_dbg_sii_iq_dequeue_unreg),
                ...
                .l5t_l2b_rdma_wren_s2           (l5t_l2b_rdma_wren_s2[15:0]), 
                .l5t_l2b_rdma_wrwl_s2           (l5t_l2b_rdma_wrwl_s2[1:0]), 
                // Inputs 
		.l5t_siu_delay			(l5t_siu_delay),
                .tcu_pce_ov                     (ce_ovrd),
                .tcu_aclk                       (aclk),
                ...
                .wmr_l                          (wmr_l), 
                .rdmat_sii_req_vld_buf          (sii_l5t_req_vld), 
  ...
  .arb_snp_snpsel_px2(arb_snp_snpsel_px2),
  .l5t_mb2_run(l5t_mb2_run),
  .l5t_mb2_rdmatag_wr_en(l5t_mb2_rdmatag_wr_en)); 
...
l5t_evctag_dp	evctag( 
		...
		// .mbist_cam_read_data(mbist_cam_read_data[41:0]),
			...
			.arbadr_ncu_l5t_pm_n_dist                 (arbadr_evctag_ncu_l5t_pm_n_dist),
		...
		.cam_mb2_rw_fail	(cam_mb2_rw_fail),
                 .evctag_addr_px2(evctag_addr_px2[39:0]), 
                 .evctag_evict_addr  (evctag_evict_addr[39:6]), 
                 .l5t_mcu_addr(l5t_mcu_addr[39:7]), 
                 .l5t_mcu_addr_5(l5t_mcu_addr_5),
                 .evctag_vuad_idx_c3 (evctag_vuad_idx_c3[8:0]), 
...
l5t_rdmarpt_dp rdmarpt 
	(
	.scan_in (rdmatag_scanout),
        .tcu_clk_stop(1'b0),
	.scan_out (rdmarpt_scanout),
  .l5t_l2b_fbrd_en_c3(l5t_l2b_fbrd_en_c3),
  .l5t_l2b_fbrd_wl_c3(l5t_l2b_fbrd_wl_c3[2:0]),
  .l5t_l2b_fbwr_wl_r2(l5t_l2b_fbwr_wl_r2[2:0]),
  .filbuf_fbd_rd_en_c2(filbuf_fbd_rd_en_c2),
  .filbuf_fbd_rd_entry_c2(filbuf_fbd_rd_entry_c2[2:0]),
  .filbuf_fbd_wr_entry_r1(filbuf_fbd_wr_entry_r1[2:0]),
  .l2clk(l2clk),
...
l5t_rdmat_ctl	 rdmat( 
        ...
        .l5t_mb2_run                   (l5t_mb2_run),
			  ...
			  .rdmat_rdmard_notdata_c12(rdmat_rdmard_notdata_c12),
                          ...
                          //.l5t_l2b_fbrd_en_c3(l5t_l2b_fbrd_en_c3), 
                          //.l5t_l2b_fbrd_wl_c3(l5t_l2b_fbrd_wl_c3[2:0]), 
                          .l5t_l2b_word_vld_c7(l5t_l2b_word_vld_c7), 
                          .l5t_l2b_ctag_en_c7(l5t_l2b_ctag_en_c7), 
                          .l5t_l2b_req_en_c7(l5t_l2b_req_en_c7), 
                          .l5t_l2b_word_c7(l5t_l2b_word_c7[3:0]), 
                           .rdmat_rdmard_cerr_c12(rdmat_rdmard_cerr_c12), 
                           .rdmat_rdmard_uerr_c12(rdmat_rdmard_uerr_c12), 
                           .rdmat_ev_uerr_r6   (rdmat_ev_uerr_r6), 
                           .rdmat_ev_cerr_r6   (rdmat_ev_cerr_r6), 
                          //.l5t_l2b_fbwr_wen_r2(l5t_l2b_fbwr_wen_r2[15:0]), 
                          //.l5t_l2b_fbd_stdatasel_c3(l5t_l2b_fbd_stdatasel_c3), 
                          .l5t_l2b_ctag_c7(l5t_l2b_ctag_c7[31:0]), // Phase 2 : SIU inteface and packet format change 2/7/04 

                          // Inputs 
                          .wbuf_reset_rdmat_vld(wbuf_reset_rdmat_vld[3:0]), 
			  .l5t_dbg_xbar_vcid_unreg	(l5t_dbg_xbar_vcid_transfer[5:0]),
			  .l5t_dbg_xbar_vcid(l5t_dbg_xbar_vcid[5:0]),
			 .l5t_dbg_sii_iq_dequeue_unreg(l5t_dbg_sii_iq_dequeue_unreg),
			 .l5t_dbg_sii_iq_dequeue(l5t_dbg_sii_iq_dequeue),
                          .wbuf_set_rdmat_acked(wbuf_set_rdmat_acked[3:0]), 
                          .arb_wbuf_inst_vld_c2(arb_wbuf_inst_vld_c2), 
                          .arb_wbuf_hit_off_c1(arb_wbuf_hit_off_c1), 
                          .arbdec_arbdp_rdma_entry_c3(arbdec_arbdp_rdma_entry_c3[1:0]), 
                          ...
                          .l2clk         (l2clk), 
                          .l2b_l5t_rdma_cerr_c10(l2b_l5t_rdma_cerr_c10), 
                          .l2b_l5t_rdma_uerr_c10(l2b_l5t_rdma_uerr_c10), 
			  .l2b_l5t_rdma_notdata_c10(l2b_l5t_rdma_notdata_c10),
                          .l2b_l5t_ev_uerr_r5(l2b_l5t_ev_uerr_r5), 
                          .l2b_l5t_ev_cerr_r5(l2b_l5t_ev_cerr_r5), 
                          .arbdec_ctag_c6(arbdec_ctag_c6[31:0]),
                          .tag_inc_rdma_cnt_c4(tag_inc_rdma_cnt_c4), 
                          .tag_set_rdma_reg_vld_c4(tag_set_rdma_reg_vld_c4), 
                          .tag_siu_req_en_c52(tag_siu_req_en_c52), 
...
//       // Outputs 
//       .l5t_dbgbus_out   (l5t_dbgbus_out[41:0]), // BS and SR 11/12/03 N2 Xbar Packet format change 
//       // Inputs 
//        .csr_l2_dbg_en          (csr_l2_dbg_en), 
//       .scan_in(dbg_scanin),
...
n2_l5t_dp_32x160_cust 	subarray_0(
       // Outputs 
...
n2_l5t_dp_32x160_cust 	subarray_1(
                             // Outputs 
...
n2_l5t_dp_32x160_cust 	subarray_2(/*AUTOINST*/ 
                             // Outputs 
...
n2_l5t_dp_32x160_cust 	subarray_3(/*AUTOINST*/ 
                             // Outputs 
...
n2_l5t_dp_32x160_cust   subarray_8(/*AUTOINST*/ 
                                   // Outputs 
...
l5t_vuadcl_dp  vuadcl_8(/*AUTOINST*/ 
                                    // Outputs 
...
n2_l5t_dp_32x160_cust   subarray_9(/*AUTOINST*/ 
                                   // Outputs 
...
n2_l5t_dp_32x160_cust   subarray_10(/*AUTOINST*/ 
                                    // Outputs 
				...
				.tcu_scan_en(tcu_scan_en),
                                   .din         ( { 
                                    ...
                                    .l2clk(l2clk),                 // Templated 
                                    .tcu_se_scancollar_in(tcu_se_scancollar_in));             // Templated 
l5t_vuadcl_dp  vuadcl_10(/*AUTOINST*/ 
                                     // Outputs 
...
n2_l5t_dp_32x160_cust   subarray_11(/*AUTOINST*/ 
                                    // Outputs 
...
l5t_dirout_dp	      out_col0	(	 
	...
	.mbist_read_data_pick_top	(l5t_mb0_icrow_row_en[0]),
	.mbist_read_data_pick_bottom	(l5t_mb0_icrow_row_en[1]),
	.mbist_lkup_wrdata		(l5t_mb0_lookup_wdata[15:0]),
	.l5t_mb0_run			(l5t_mb0_run),
...
l5t_dirout_dp	      dc_out_col0	(	 
	  ...
	  .tcu_clk_stop(1'b0),
          ...
          // Inputs 
	.mbist_read_data_pick_top	(l5t_mb0_dcrow_row_en[0]),
	.mbist_read_data_pick_bottom	(l5t_mb0_dcrow_row_en[1]),
	.mbist_lkup_wrdata		(l5t_mb0_lookup_wdata[15:0]),
	.l5t_mb0_run			(l5t_mb0_run),
...
l5t_dirtop_ctl		ic_row0_ctl
	...
	.tcu_scan_en                  		(tcu_scan_en),
	.l5t_mb0_run                  		(l5t_mb0_run),
	.l5t_mb0_mask                 		(l5t_mb0_mask[7:0]),
	.l5t_mb0_addr                 		(l5t_mb0_addr[5:0]),
	.l5t_mb0_row_panel_en         		(l5t_mb0_icrow_panel_en[3:0]),
	.l5t_mb0_row_row_en           		(l5t_mb0_icrow_row_en[0]),
	.l5t_mb0_row_lookup_en        		(l5t_mb0_icrow_lookup_en[3:0]),
	.l5t_mb0_lookup_wdata         		(l5t_mb0_lookup_wdata[15:0]),
	.l5t_mb0_row_wr_en            		(l5t_mb0_icrow_wr_en),
	.l5t_mb0_row_rd_en            		(l5t_mb0_icrow_rd_en),
	.ic_dc_dir                    		(1'b1),
...
l5t_dirtop_ctl          ic_row2_ctl
        ...
        .l5t_mb0_addr                           (l5t_mb0_addr[5:0]),
        .l5t_mb0_row_panel_en                   (l5t_mb0_icrow_panel_en[3:0]),
        .l5t_mb0_row_row_en                     (l5t_mb0_icrow_row_en[1]),
        .l5t_mb0_row_lookup_en                  (l5t_mb0_icrow_lookup_en[3:0]),
        .l5t_mb0_lookup_wdata                   (l5t_mb0_lookup_wdata[15:0]),
        .l5t_mb0_row_wr_en                      (l5t_mb0_icrow_wr_en),
        .l5t_mb0_row_rd_en                      (l5t_mb0_icrow_rd_en),
...
l5t_dirtop_ctl          dc_row0_ctl
        ...
        .l5t_mb0_mask                           (l5t_mb0_mask[7:0]),
        .l5t_mb0_addr                           (l5t_mb0_addr[5:0]),
        .l5t_mb0_row_panel_en                   (l5t_mb0_dcrow_panel_en[3:0]),
        .l5t_mb0_row_row_en                     (l5t_mb0_dcrow_row_en[0]),
        .l5t_mb0_row_lookup_en                  (l5t_mb0_dcrow_lookup_en[3:0]),
        .l5t_mb0_lookup_wdata                   (l5t_mb0_lookup_wdata[15:0]),
        .l5t_mb0_row_wr_en                      (l5t_mb0_dcrow_wr_en),
        .l5t_mb0_row_rd_en                      (l5t_mb0_dcrow_rd_en),
        .ic_dc_dir                              (1'b0),
...
l5t_dirtop_ctl          dc_row2_ctl
        ...
        .l5t_mb0_addr                           (l5t_mb0_addr[5:0]),
        .l5t_mb0_row_panel_en                   (l5t_mb0_dcrow_panel_en[3:0]),
        .l5t_mb0_row_row_en                     (l5t_mb0_dcrow_row_en[1]),
        .l5t_mb0_row_lookup_en                  (l5t_mb0_dcrow_lookup_en[3:0]),
        .l5t_mb0_lookup_wdata                   (l5t_mb0_lookup_wdata[15:0]),
        .l5t_mb0_row_wr_en                      (l5t_mb0_dcrow_wr_en),
        .l5t_mb0_row_rd_en                      (l5t_mb0_dcrow_rd_en),
...
l5t_rep_dp      repeater
        (
        .rep_in0        (l5t_rep_in0[23:0]),
        .rep_in1        (l5t_rep_in1[23:0]),
        .rep_in2        (l5t_rep_in2[23:0]),
        .rep_in3        (l5t_rep_in3[23:0]),
        .rep_in4        (l5t_rep_in4[23:0]),
        .rep_in5        (l5t_rep_in5[23:0]),
        .rep_in6        (l5t_rep_in6[23:0]),
        .rep_in7        (l5t_rep_in7[23:0]),
        .rep_in8        (l5t_rep_in8[23:0]),
        .rep_in9        (l5t_rep_in9[23:0]),
        .rep_in10       (l5t_rep_in10[23:0]),
        .rep_in11       (l5t_rep_in11[23:0]),
        .rep_in12       (l5t_rep_in12[23:0]),
        .rep_in13       (l5t_rep_in13[23:0]),
        .rep_in14       (l5t_rep_in14[23:0]),
        .rep_in15       (l5t_rep_in15[23:0]),
        .rep_in16       (l5t_rep_in16[23:0]),
        .rep_in17       (l5t_rep_in17[23:0]),
        .rep_in18       (l5t_rep_in18[23:0]),
        .rep_in19       (l5t_rep_in19[23:0]),
        .rep_out0       (l5t_rep_out0[23:0]),
        .rep_out1       (l5t_rep_out1[23:0]),
        .rep_out2       (l5t_rep_out2[23:0]),
        .rep_out3       (l5t_rep_out3[23:0]),
        .rep_out4       (l5t_rep_out4[23:0]),
        .rep_out5       (l5t_rep_out5[23:0]),
        .rep_out6       (l5t_rep_out6[23:0]),
        .rep_out7       (l5t_rep_out7[23:0]),
        .rep_out8       (l5t_rep_out8[23:0]),
        .rep_out9       (l5t_rep_out9[23:0]),
        .rep_out10      (l5t_rep_out10[23:0]),
        .rep_out11      (l5t_rep_out11[23:0]),
        .rep_out12      (l5t_rep_out12[23:0]),
        .rep_out13      (l5t_rep_out13[23:0]),
        .rep_out14      (l5t_rep_out14[23:0]),
        .rep_out15      (l5t_rep_out15[23:0]),
        .rep_out16      (l5t_rep_out16[23:0]),
        .rep_out17      (l5t_rep_out17[23:0]),
        .rep_out18      (l5t_rep_out18[23:0]),
        .rep_out19      (l5t_rep_out19[23:0])
        );

l5t_ffrpt_dp	left_ffrptr	
	(
	.data_in		(l5t_lstg_in[191:0]),
	.tcu_clk_stop           (1'b0),     
	.tcu_pce_ov             (tcu_pce_ov),       
	.tcu_scan_en            (tcu_scan_en),        
	.tcu_aclk               (tcu_aclk),
	...
	.l2clk                  (l2clk),
	.data_out               (l5t_lstg_out[191:0])
	);

l5t_ffrpt_dp    right_ffrptr     
        (
        .data_in                (l5t_rstg_in[191:0]),
        .tcu_clk_stop           (1'b0), 
        .tcu_pce_ov             (tcu_pce_ov), 
        .tcu_scan_en            (tcu_scan_en), 
        .tcu_aclk               (tcu_aclk),
...
l5t_mrep16x8_dp     mrep_besides_tagl 
        (
...
l5t_mrep8x16_dp     mrep_besides_mbdata 
        (
...
l5t_mrep32x3_dp   mrep_arbdat_top
         ( 
...
l5t_mrep32x3_dp   mrep_arbdat_bot //1
         (
...
l5t_mrep32x3_dp   mrep_arbdec_top //1
         (
...
l5t_mrep2x64_dp   mrep_besides_arbadr //1
         ( 
...
l5t_mb2_ctl		mb2_control	
	(
	.mb2_l5t_run			(l5t_mb2_run),
//	.mb2_l5t_cambist		(mb2_l5t_cambist),
	.mb2_l5t_addr			(l5t_mb2_addr[4:0]),
	.mb2_l5t_wdata			(l5t_mb2_wdata[7:0]),
	.mb2_l5t_mbtag_wr_en        	(l5t_mb2_mbtag_wr_en),
	.mb2_l5t_mbtag_rd_en        	(l5t_mb2_mbtag_rd_en),
	.mb2_l5t_mbtag_lookup_en    	(l5t_mb2_mbtag_lookup_en),
	.mb2_l5t_wk1_cam_init		(mb2_l5t_wk1_cam_init),
	.mb2_l5t_wk1_cam_shift		(mb2_l5t_wk1_cam_shift),
        .cam_mb2_cam_fail		({rdma_mbist_cam_hit,wb_mbist_cam_hit,
					  fb_mbist_cam_hit,mb_mbist_cam_hit}),
	.mb2_l5t_fbtag_wr_en            (l5t_mb2_fbtag_wr_en),
	.mb2_l5t_fbtag_rd_en            (l5t_mb2_fbtag_rd_en),
	.mb2_l5t_fbtag_lookup_en        (l5t_mb2_fbtag_lookup_en),
	.mb2_l5t_wbtag_wr_en            (l5t_mb2_wbtag_wr_en),
	.mb2_l5t_wbtag_rd_en            (l5t_mb2_wbtag_rd_en),
	.mb2_l5t_wbtag_lookup_en        (l5t_mb2_wbtag_lookup_en),
	.mb2_l5t_rdmatag_wr_en          (l5t_mb2_rdmatag_wr_en),
	.mb2_l5t_rdmatag_rd_en          (l5t_mb2_rdmatag_rd_en),
	.mb2_l5t_rdmatag_lookup_en      (l5t_mb2_rdmatag_lookup_en),
	.mb2_l5t_mbdata_wr_en           (l5t_mb2_mbdata_wr_en),
	.mb2_l5t_mbdata_rd_en           (l5t_mb2_mbdata_rd_en),
	.cam_mb2_rw_fail		(cam_mb2_rw_fail),	
	.mb2_cmp_sel			(mbdata_cmp_sel[3:0]),	
	.mbdata_mb2_rw_fail		(mbdata_fail),
	.mb2_l5t_iqarray_wr_en  	(l5t_mb2_iqarray_wr_en),
	.mb2_l5t_iqarray_rd_en  	(l5t_mb2_iqarray_rd_en),
	.iqarray_mb2_rw_fail		(iqu_fail_reg),
	.l5t_mb2_done           	(l5t_tcu_mbist2_done),
	.l5t_mb2_fail           	(l5t_tcu_mbist2_fail),
	.mbist_cam_sel			(mbist_cam_sel[3:0]),
	.scan_in(tcu_l5t_mbist_scan_in1),
	.scan_out(tcu_l5t_mbist_scan_in2),
	.l2clk         		        (l2clk),
	.tcu_pce_ov    		        (tcu_pce_ov),
	.tcu_aclk      		        (tcu_aclk),
	.tcu_bclk      		        (tcu_bclk),
...
l5t_mb0_ctl	mb0	(
	.mb0_l5t_run			(l5t_mb0_run),
	.mb0_l5t_cambist		(mb0_l5t_cambist),
	.mb0_l5t_addr			(l5t_mb0_addr[5:0]),
	.mb0_l5t_lookup_wdata 		(l5t_mb0_lookup_wdata[15:0]),
	.mb0_l5t_icrow_wr_en    	(l5t_mb0_icrow_wr_en),
	.mb0_l5t_icrow_rd_en    	(l5t_mb0_icrow_rd_en),
	.mb0_l5t_icrow_lookup_en	(l5t_mb0_icrow_lookup_en[3:0]),
	.mb0_l5t_icrow_row_en		(l5t_mb0_icrow_row_en[1:0]),
	.mb0_l5t_icrow_panel_en		(l5t_mb0_icrow_panel_en[3:0]),
	.mb0_l5t_mask			(l5t_mb0_mask[7:0]),
	.mb0_l5t_dcrow_wr_en    	(l5t_mb0_dcrow_wr_en),
	.mb0_l5t_dcrow_rd_en    	(l5t_mb0_dcrow_rd_en),
	.mb0_l5t_dcrow_lookup_en	(l5t_mb0_dcrow_lookup_en[3:0]),
	.mb0_l5t_dcrow_row_en		(l5t_mb0_dcrow_row_en[1:0]),
	.mb0_l5t_dcrow_panel_en		(l5t_mb0_dcrow_panel_en[3:0]),
	.mb0_l5t_oqarray_wr_en  	(l5t_mb0_oqarray_wr_en),
	.mb0_l5t_oqarray_rd_en  	(l5t_mb0_oqarray_rd_en),
	.mb0_l5t_done           	(l5t_tcu_mbist0_done),
	.mb0_l5t_fail           	(l5t_tcu_mbist0_fail),
	.mb0_l5t_cmpsel			(mbist_oqarray_sel[3:0]),
	.mb0_l5t_mbist_write_data	(mb0_l5t_mbist_write_data[7:0]),
	.ic_cam_fail			(ic_cam_fail[1:0]),
	.dc_cam_fail			(dc_cam_fail[1:0]),
	...
	.oqarray_rw_fail		(oqarray_rw_fail),
	.scan_in(tcu_l5t_mbist_scan_in2),
	.scan_out(l5t_tcu_mbist_scan_out),
	.l2clk                  	(l2clk),
	.tcu_pce_ov             	(tcu_pce_ov),
	.tcu_clk_stop             	(1'b0),
	.tcu_aclk               	(tcu_aclk),
...
l5t_taghdr_ctl l5tag_sram_hdr
        (
        .efu_hdr_write_data        (efu_l5t_fuse_data),     
        .efu_hdr_xfer_en           (efu_l5t_fuse_xfer_en),   
        .efu_hdr_clr               (efu_l5t_fuse_clr), 
        .cmp_io_sync_en            (cmp_io_sync_en),
        .io_cmp_sync_en            (io_cmp_sync_en),
        .sram_hdr_read_data        ({1'b0,tag_fuse_read_data[5:0]}),
        .scan_in(l5tag_sram_hdr_scanin),
        .scan_out(l5tag_sram_hdr_scanout),
        .l2clk                     (l2clk), 
        .tcu_pce_ov                (tcu_pce_ov),
        .tcu_aclk                  (tcu_aclk),
        .tcu_bclk                  (tcu_bclk),
        .tcu_scan_en               (tcu_scan_en),
        .tcu_clk_stop              (1'b0),
        .hdr_efu_read_data         (l5t_efu_fuse_data),
        .hdr_efu_xfer_en           (l5t_efu_fuse_xfer_en),
        .hdr_sram_rvalue           (l5t_tag_rvalue[6:0]),
        .hdr_sram_rid              (l5t_tag_rid[3:0]),
        .hdr_sram_wr_en            (l5t_tag_wr_en),
        .hdr_sram_red_clr          (l5t_tag_fuse_clr)
        );

 
// fixscan start:
assign l5t_clk_header_scanin     = scan_in                  ;
assign vuad_scanin               = l5t_clk_header_scanout   ;
...
assign l5tag_sram_hdr_scanin     = right_ffrptr_scanout     ;
assign scan_out                  = l5tag_sram_hdr_scanout   ;
// fixscan end:
endmodule 
